      ...
      <DocsTemplate.Subsection title="Component Tokens">
        <DocsTemplate.TokenTable
          tokens={[
            ...
            { name: '--milestones-gap-sm',           description: 'Inter-dot gap for size sm — var(--global-spacing-sizing-4px) 4px.' },
            { name: '--milestones-gap-default',      description: 'Inter-dot gap for size default — var(--global-spacing-sizing-6px) 6px.' },
            { name: '--milestones-gap-lg',           description: 'Inter-dot gap for size lg — var(--global-spacing-sizing-8px) 8px.' },
            { name: '--milestones-label-gap-sm',     description: 'Track-to-label spacing for size sm — var(--global-spacing-sizing-4px) 4px. (min 4px)' },
            { name: '--milestones-label-gap-default',description: 'Track-to-label spacing for size default — var(--global-spacing-sizing-8px) 8px.' },
            { name: '--milestones-label-gap-lg',     description: 'Track-to-label spacing for size lg — var(--global-spacing-sizing-16px) 16px. (max 16px)' },
