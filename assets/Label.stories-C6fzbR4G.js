...
);`}),e.jsx(a.Section,{title:"Visual style",subtitle:"Labels support different visual weights, dropdown variations, and alignments. Ensure appropriate contrast ratios when switching between brands."}),e.jsx(a.Subsection,{title:"Weights"}),e.jsx(a.BodyText,{children:"The Label component supports four font weights: bold, medium, light, and thin. Use systematic weights for consistent hierarchy throughout the interface."}),e.jsx(a.DosDonts,{doItem:{icon:e.jsx("span",{style:{fontWeight:"var(--global-type-weight-bold)",fontSize:"var(--global-type-size-primary-label-lg)"},children:"Aa"}),description:"Use systematic weights (bold, medium, light, thin) for consistent hierarchy."},dontItem:{icon:e.jsx("span",{style:{fontWeight:450,fontSize:"var(--global-type-size-primary-label-lg)"},children:"Aa"}),description:"Overwrite internal component styles directly; use the token system. Avoid creating new custom weights or hardcoding pixel sizes."}}),e.jsx(a.Subsection,{title:"Alignment"}),e.jsx(a.BodyText,{children:"Labels can be aligned left, centre, or right. Choose alignment that matches the context of the surrounding layout."}),e.jsx(a.Section,{title:"Size & spacing",subtitle:"The Label component supports multiple sizes. Use the size prop to ensure consistent scaling alongside other components."}),e.jsx(a.SizeDemo,{rows:[{label:"Large",sublabel:"Use for headings and emphasis",children:e.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-lg)",fontWeight:"var(--global-type-weight-bold)"},children:"Label"})},{label:"Default",sublabel:"Use in most cases",children:e.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label)",fontWeight:"var(--global-type-weight-bold)"},children:"Label"})},{label:"Small",sublabel:"Use sparingly",children:e.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-sm)",fontWeight:"var(--global-type-weight-bold)"},children:"Label"})},{label:"X-Small",sublabel:"Use rarely",children:e.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-xs)",fontWeight:"var(--global-type-weight-bold)"},children:"Label"})},{label:"2X-Small",sublabel:"Use rarely",children:e.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-xxs)",fontWeight:"var(--global-type-weight-bold)"},children:"Label"})}]}),e.jsx(a.BodyText,{children:"This component provides 120 possible variants: 5 sizes × 4 weights × 3 alignments × 2 dropdown states. See the interactive stories for a full variant matrix."}),e.jsxs(a.Section,{title:"Contribution",children:[e.jsx(a.BodyText,{children:"When proposing updates or new properties for the Label component, consider the following:"}),e.jsx(a.BulletList,{ordered:!0,items:["Does the proposed change align with existing typography scales?","Does it maintain backward compatibility with our systematic sizing approach?"]}),e.jsxs(a.BodyText,{children:["To contribute a new variation, please bring it to our"," ",e.jsx("strong",{children:"Biweekly Design System meeting"})," for review with the whole team. If you need the calendar invite forwarding, please send the"," ",e.jsx("strong",{children:"design team"})," a message on Teams."]})]}),e.jsx(a.Footer,{})]});L.__docgenInfo={description:"",methods:[],displayName:"LabelDocs"};const Oe={title:"Foundation/Label",component:i,parameters:{docs:{page:()=>e.jsx(L,{})}},argTypes:{size:{control:"select",options:["large","default","small","x-small","2x-small"]},weight:{control:"select",options:["bold","medium","light","thin"]},font:{control:"select",options:["primary","secondary"]},align:{control:"select",options:["left","centre","right"]},leadingIcon:{control:"select",options:["Person","Mail","Settings","None"],mapping:{Person:fe,Mail:Ie,Settings:ke,None:null}},showLeadingIcon:{control:"boolean"},showTrailingIcon:{control:"boolean"},dropdown:{control:"boolean"},showSplit:{control:"boolean"}},decorators:[r=>e.jsx("div",{style:{padding:"var(--global-spacing-sizing-20px)"},children:e.jsx(r,{})})]},d={render:()=>e.jsx(L,{}),parameters:{controls:{disable:!0},actions:{disable:!0},chromatic:{disableSnapshot:!0}}},n=({weight:r})=>{const s=["large","default","small","x-small","2x-small"],b=["left","centre","right"];return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-40px)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--global-spacing-sizing-20px)"},children:[e.jsxs("h2",{style:{margin:0,textTransform:"uppercase",letterSpacing:"var(--global-spacing-sizing-1px)"},children:[r," weight variants"]}),e.jsx("div",{style:{height:"var(--global-spacing-stroke-2px)",flexGrow:1,backgroundColor:"var(--global-color-neutral-gray-200)"}})]}),e.jsx("div",{style:{overflowX:"auto"},children:e.jsxs("table",{style:{borderCollapse:"collapse",width:"100%",minWidth:"1000px"},children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{style:j,children:"Size"}),b.map(t=>e.jsxs(_.Fragment,{children:[e.jsx("th",{style:j,children:t}),e.jsxs("th",{style:j,children:[t," + Dropdown"]})]},t))]})}),e.jsx("tbody",{children:s.map(t=>e.jsxs("tr",{style:{borderBottom:"var(--global-spacing-stroke-1px) solid var(--global-color-neutral-gray-100)"},children:[e.jsx("td",{style:{...z,fontWeight:"var(--global-type-weight-bold)",color:"var(--global-color-neutral-gray-600)",width:"100px"},children:t}),b.map(o=>e.jsxs(_.Fragment,{children:[e.jsx("td",{style:z,children:e.jsx(i,{size:t,weight:r,align:o,dropdown:!1,children:"Label"})}),e.jsx("td",{style:z,children:e.jsx(i,{size:t,weight:r,align:o,dropdown:!0,children:"Label"})})]},o))]},t))})]})})]})},j={textAlign:"left",padding:"var(--global-spacing-sizing-12px)",color:"var(--global-color-neutral-gray-400)",fontSize:"var(--global-type-size-primary-label-xs)",textTransform:"uppercase",borderBottom:"var(--global-spacing-stroke-2px) solid var(--global-color-neutral-gray-200)"},z={padding:"var(--global-spacing-sizing-16px) var(--global-spacing-sizing-12px)"},u={args:{children:"Label",size:"default",weight:"bold",align:"left",dropdown:!1,showTrailingIcon:!0}},x={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-20px)"},children:[e.jsx(i,{size:"large",children:"Large Label"}),e.jsx(i,{size:"default",children:"Default Label"}),e.jsx(i,{size:"small",children:"Small Label"}),e.jsx(i,{size:"x-small",children:"X-Small Label"}),e.jsx(i,{size:"2x-small",children:"2X-Small Label"})]})},y={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-20px)"},children:[e.jsx(i,{weight:"bold",children:"Bold Weight"}),e.jsx(i,{weight:"medium",children:"Medium Weight"}),e.jsx(i,{weight:"light",children:"Light Weight"}),e.jsx(i,{weight:"thin",children:"Thin Weight"})]})},f={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-20px)",width:"400px",border:"var(--global-spacing-stroke-1px) dashed var(--global-color-neutral-gray-200)",padding:"var(--global-spacing-sizing-20px)"},children:[e.jsxs("div",{children:[e.jsx("span",{style:{fontSize:"var(--global-type-size-primary-label-xs)",color:"var(--global-color-neutral-gray-400)"},children:"Left"}),e.jsx(i,{align:"left",children:"Left Aligned"})]}),e.jsxs("div",{children:[e.jsx("span",{style:{fontSize:"var(--global-type-size-primary-label-xs)",color:"var(--global-color-neutral-gray-400)"},children:"Centre"}),e.jsx(i,{align:"centre",children:"Centre Aligned"})]}),e.jsxs("div",{children:[e.jsx("span",{style:{fontSize:"var(--global-type-size-primary-label-xs)",color:"var(--global-color-neutral-gray-400)"},children:"Right"}),e.jsx(i,{align:"right",children:"Right Aligned"})]})]})},c={name:"Systematic: Bold (30 variants)",render:()=>e.jsx(n,{weight:"bold"})},p={name:"Systematic: Medium (30 variants)",render:()=>e.jsx(n,{weight:"medium"})},g={name:"Systematic: Light (30 variants)",render:()=>e.jsx(n,{weight:"light"})},m={name:"Systematic: Thin (30 variants)",render:()=>e.jsx(n,{weight:"thin"})},h={name:"Full Matrix (120 variants)",render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-80px)"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"var(--global-spacing-sizing-20px)"},children:[e.jsx("h1",{style:{margin:0},children:"Label Component Variant Matrix"}),e.jsx("p",{style:{color:"var(--global-color-neutral-gray-600)"},children:"5 Sizes × 4 Weights × 3 Alignments × 2 Dropdown States = 120 Variants"})]}),e.jsx(n,{weight:"bold"}),e.jsx(n,{weight:"medium"}),e.jsx(n,{weight:"light"}),e.jsx(n,{weight:"thin"})]})},v={args:{dropdown:!0}};var D,W,I,k,F;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: () => <LabelDocs />,
  parameters: {
    controls: {
      disable: true
...
}`,...(I=(W=d.parameters)==null?void 0:W.docs)==null?void 0:I.source},description:{story:"Full branded documentation page for the Label component.",...(F=(k=d.parameters)==null?void 0:k.docs)==null?void 0:F.description}}};var A,C,M;u.parameters={...u.parameters,docs:{...(A=u.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    children: 'Label',
    size: 'default',
    weight: 'bold',
...
}`,...(M=(C=u.parameters)==null?void 0:C.docs)==null?void 0:M.source}}};var V,B,P;x.parameters={...x.parameters,docs:{...(V=x.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(P=(B=x.parameters)==null?void 0:B.docs)==null?void 0:P.source}}};var R,U,q;y.parameters={...y.parameters,docs:{...(R=y.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: 'var(--global-spacing-sizing-20px)'
...
}`,...(q=(U=y.parameters)==null?void 0:U.docs)==null?void 0:q.source}}};var X,N,E;f.parameters={...f.parameters,docs:{...(X=f.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: 'var(--global-spacing-sizing-20px)',
...
}`,...(E=(N=f.parameters)==null?void 0:N.docs)==null?void 0:E.source}}};var H,G,O,$,K;c.parameters={...c.parameters,docs:{...(H=c.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: 'Systematic: Bold (30 variants)',
  render: () => <WeightMatrix weight="bold" />
}`,...(O=(G=c.parameters)==null?void 0:G.docs)==null?void 0:O.source},description:{story:"Bold variants systematic overview",...(K=($=c.parameters)==null?void 0:$.docs)==null?void 0:K.description}}};var J,Q,Y,Z,ee;p.parameters={...p.parameters,docs:{...(J=p.parameters)==null?void 0:J.docs,source:{originalSource:`{
  name: 'Systematic: Medium (30 variants)',
  render: () => <WeightMatrix weight="medium" />
}`,...(Y=(Q=p.parameters)==null?void 0:Q.docs)==null?void 0:Y.source},description:{story:"Medium variants systematic overview",...(ee=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};var ae,ie,te,le,ne;g.parameters={...g.parameters,docs:{...(ae=g.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  name: 'Systematic: Light (30 variants)',
  render: () => <WeightMatrix weight="light" />
}`,...(te=(ie=g.parameters)==null?void 0:ie.docs)==null?void 0:te.source},description:{story:"Light variants systematic overview",...(ne=(le=g.parameters)==null?void 0:le.docs)==null?void 0:ne.description}}};var re,se,oe,de,ce;m.parameters={...m.parameters,docs:{...(re=m.parameters)==null?void 0:re.docs,source:{originalSource:`{
  name: 'Systematic: Thin (30 variants)',
  render: () => <WeightMatrix weight="thin" />
}`,...(oe=(se=m.parameters)==null?void 0:se.docs)==null?void 0:oe.source},description:{story:"Thin variants systematic overview",...(ce=(de=m.parameters)==null?void 0:de.docs)==null?void 0:ce.description}}};var pe,ge,me,he,be;h.parameters={...h.parameters,docs:{...(pe=h.parameters)==null?void 0:pe.docs,source:{originalSource:`{
...
}`,...(me=(ge=h.parameters)==null?void 0:ge.docs)==null?void 0:me.source},description:{story:"Comprehensive overview of all 120 variants",...(be=(he=h.parameters)==null?void 0:he.docs)==null?void 0:be.description}}};var ue,xe,ye;v.parameters={...v.parameters,docs:{...(ue=v.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  args: {
    dropdown: true
  }
}`,...(ye=(xe=v.parameters)==null?void 0:xe.docs)==null?void 0:ye.source}}};const $e=["Documentation","Default","Sizes","Weights","Alignments","BoldVariants","MediumVariants","LightVariants","ThinVariants","AllVariants","WithDropdown"];export{f as Alignments,h as AllVariants,c as BoldVariants,u as Default,d as Documentation,g as LightVariants,p as MediumVariants,x as Sizes,m as ThinVariants,y as Weights,v as WithDropdown,$e as __namedExportsOrder,Oe as default};
