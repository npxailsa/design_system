...
/>`}),e.jsxs(a.Principles,{children:[e.jsxs(a.PrincipleCard,{number:1,title:"Drive status from your save logic",children:["Map your application's save lifecycle (idle → saving → saved / error) directly to the"," ",e.jsx("code",{children:"status"})," prop. Never manually set colours or labels — let the token system handle visual consistency."]}),e.jsx(a.PrincipleCard,{number:2,title:"Persist the button across all states",children:"Keep the button visible in all states, including saved and error. Hiding it removes important feedback for the user about their document's save status."}),e.jsx(a.PrincipleCard,{number:3,title:"Only one SaveDraftButton per form",children:"Use a single SaveDraftButton per document or form scope. Multiple buttons suggest multiple save targets, which is confusing. If you need section-level saves, use text links instead."})]}),e.jsx(a.Footer,{})]});g.__docgenInfo={description:"",methods:[],displayName:"SaveDraftButtonDocs"};const R=["default","auto-saving","saving","saved","error","disabled","focused"],ee={title:"Atoms/Save Draft Button",component:s,parameters:{docs:{page:()=>e.jsx(g,{})}},argTypes:{status:{control:"select",options:R,description:"Drives the label, background, border, and text colour of the button"},label:{control:"text",description:"Overrides the auto-derived label for the current status"}},args:{status:"default"}},n={render:()=>e.jsx(g,{}),parameters:{controls:{disable:!0},actions:{disable:!0}}},o={args:{status:"default"}},i={name:"Auto-saving",args:{status:"auto-saving"}},l={args:{status:"saving"}},d={args:{status:"saved"}},c={args:{status:"error"}},u={args:{status:"disabled"}},v={name:"All States",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-16px)",padding:"var(--global-spacing-sizing-24px)",alignItems:"flex-start"},children:R.map(t=>e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--global-spacing-sizing-20px)"},children:[e.jsx(s,{status:t}),e.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-xs)",color:"var(--global-color-neutral-gray-500)",textTransform:"capitalize"},children:t})]},t))}),parameters:{controls:{disable:!0}}};var x,h,y;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
