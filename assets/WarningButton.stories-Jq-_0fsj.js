...
}`,...(w=(y=o.parameters)==null?void 0:y.docs)==null?void 0:w.source},description:{story:"Full documentation — design specs, token table, and usage examples.",...(W=(j=o.parameters)==null?void 0:j.docs)==null?void 0:W.description}}};var z,B,C,k,S;l.parameters={...l.parameters,docs:{...(z=l.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
...
}`,...(C=(B=l.parameters)==null?void 0:B.docs)==null?void 0:C.source},description:{story:"Interactive playground — adjust all props via the Controls panel.",...(S=(k=l.parameters)==null?void 0:k.docs)==null?void 0:S.description}}};var _,T,D,L,F;d.parameters={...d.parameters,docs:{...(_=d.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    label: 'Warning button',
    variant: 'solid',
    size: 'default'
  }
}`,...(D=(T=d.parameters)==null?void 0:T.docs)==null?void 0:D.source},description:{story:`Solid variant — amber filled (#F4A403) background, black text and icons.
Use as the primary CTA in warning-status CardContent cards.`,...(F=(L=d.parameters)==null?void 0:L.docs)==null?void 0:F.description}}};var A,I,M,H,V;g.parameters={...g.parameters,docs:{...(A=g.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    label: 'Warning button',
    variant: 'ghost',
    size: 'default'
  }
}`,...(M=(I=g.parameters)==null?void 0:I.docs)==null?void 0:M.source},description:{story:`Ghost / alt variant — white background, orange border, dark-orange text.
Hover shifts the background to orange-light (#FEF4DA).
Use as the secondary CTA alongside the solid warning button.`,...(V=(H=g.parameters)==null?void 0:H.docs)==null?void 0:V.description}}};var E,R,N,U,P;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '8px',
    alignItems: 'center',
...
}`,...(N=(R=c.parameters)==null?void 0:R.docs)==null?void 0:N.source},description:{story:"Both variants side by side — as they appear in a warning CardContent ButtonGroup.",...(P=(U=c.parameters)==null?void 0:U.docs)==null?void 0:P.description}}};var G,q,O,Z,X;p.parameters={...p.parameters,docs:{...(G=p.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(O=(q=p.parameters)==null?void 0:q.docs)==null?void 0:O.source},description:{story:"All three sizes — small (34px), default (44px), large (56px).",...(X=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:X.description}}};var Y,$,J,K,Q;b.parameters={...b.parameters,docs:{...(Y=b.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(J=($=b.parameters)==null?void 0:$.docs)==null?void 0:J.source},description:{story:"Loading state — spinner replaces the leading icon, trailing icon is hidden.",...(Q=(K=b.parameters)==null?void 0:K.docs)==null?void 0:Q.description}}};var aa,ea,na,ta,ia;u.parameters={...u.parameters,docs:{...(aa=u.parameters)==null?void 0:aa.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(na=(ea=u.parameters)==null?void 0:ea.docs)==null?void 0:na.source},description:{story:"Disabled state — grey background, grey text, not interactive.",...(ia=(ta=u.parameters)==null?void 0:ta.docs)==null?void 0:ia.description}}};var ra,sa,oa,la,da;h.parameters={...h.parameters,docs:{...(ra=h.parameters)==null?void 0:ra.docs,source:{originalSource:`{
...
}`,...(oa=(sa=h.parameters)==null?void 0:sa.docs)==null?void 0:oa.source},description:{story:"Full state matrix — all combinations of variant × size × state.",...(da=(la=h.parameters)==null?void 0:la.docs)==null?void 0:da.description}}};const Ia=["Documentation","Playground","Solid","Ghost","BothVariants","Sizes","Loading","Disabled","FullDesignMatrix"];export{c as BothVariants,u as Disabled,o as Documentation,h as FullDesignMatrix,g as Ghost,b as Loading,l as Playground,p as Sizes,d as Solid,Ia as __namedExportsOrder,Aa as default};
