import{j as e}from"./iframe-V9rbRwOw.js";import{D as t}from"./DocsTemplate-j2Q6Umhq.js";import"./preload-helper-Dp1pzeXC.js";const me="_root_mjemd_21",ue="_track_mjemd_31",ge="_dot_mjemd_39",xe="_label_mjemd_60",n={root:me,track:ue,dot:ge,"dot--active":"_dot--active_mjemd_50","dot--inactive":"_dot--inactive_mjemd_54",label:xe,"root--sm":"_root--sm_mjemd_76","root--default":"_root--default_mjemd_92","root--lg":"_root--lg_mjemd_108"},a=({value:s,size:r="default",showLabel:re=!0,steps:S=10,className:ne="",ariaLabel:le="Milestone progress"})=>{const z=Math.min(100,Math.max(0,s)),oe=Math.round(z/100*S),de=[n.root,n[`root--${r}`],ne].filter(Boolean).join(" ");return e.jsxs("div",{className:de,role:"progressbar","aria-label":le,"aria-valuenow":z,"aria-valuemin":0,"aria-valuemax":100,children:[e.jsx("div",{className:n.track,children:Array.from({length:S},(ve,w)=>{const ce=w<oe,pe=[n.dot,ce?n["dot--active"]:n["dot--inactive"]].join(" ");return e.jsx("span",{className:pe,"aria-hidden":"true"},w)})}),re&&e.jsxs("span",{className:n.label,children:[z,"%"]})]})};a.__docgenInfo={description:"",methods:[],displayName:"Milestones",props:{value:{required:!0,tsType:{name:"number"},description:`Current progress value as a percentage (0–100).
...
}`,...(k=(W=c.parameters)==null?void 0:W.docs)==null?void 0:k.source}}};var _,M,A;p.parameters={...p.parameters,docs:{...(_=p.parameters)==null?void 0:_.docs,source:{originalSource:`{
  name: 'Playground',
...
}`,...(A=(M=p.parameters)==null?void 0:M.docs)==null?void 0:A.source}}};var D,C,T;m.parameters={...m.parameters,docs:{...(D=m.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: 'Size / Small',
  render: () => <div style={{
    minWidth: '200px',
    width: '100%',
...
}`,...(U=(P=u.parameters)==null?void 0:P.docs)==null?void 0:U.source}}};var E,q,N;g.parameters={...g.parameters,docs:{...(E=g.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: 'Size / Large',
  render: () => <div style={{
    minWidth: '200px',
    width: '100%',
...
}`,...(N=(q=g.parameters)==null?void 0:q.docs)==null?void 0:N.source}}};var I,F,R;x.parameters={...x.parameters,docs:{...(I=x.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(te=(ae=y.parameters)==null?void 0:ae.docs)==null?void 0:te.source}}};const ze=["Documentation","Playground","SizeSmall","SizeDefault","SizeLarge","AllSizes","WithoutLabel","CustomSteps","ZeroPercent","HalfPercent","FullPercent"];export{x as AllSizes,v as CustomSteps,c as Documentation,y as FullPercent,f as HalfPercent,p as Playground,u as SizeDefault,g as SizeLarge,m as SizeSmall,h as WithoutLabel,b as ZeroPercent,ze as __namedExportsOrder,je as default};
