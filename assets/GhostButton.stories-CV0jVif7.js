import{j as e}from"./iframe-D_NHC_Vq.js";import{D as i}from"./DocsTemplate-C_AIFsVX.js";import{A as n,P as l}from"./Person-CkMrGxRl.js";import{D as Oe,A as f}from"./Download-CINj65T_.js";import{E as T}from"./Edit-BB-oLKG0.js";import{B as Ve}from"./Button-Che7PE9l.js";import{C as O}from"./Check-BTpkO98A.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-9tgycZPX.js";const o={"ghost-btn":"_ghost-btn_qw2vz_24","ghost-btn--ghost":"_ghost-btn--ghost_qw2vz_79","ghost-btn--disabled":"_ghost-btn--disabled_qw2vz_86","ghost-btn--loading":"_ghost-btn--loading_qw2vz_126","ghost-btn--link":"_ghost-btn--link_qw2vz_136","ghost-btn--extra-small":"_ghost-btn--extra-small_qw2vz_198","ghost-btn--small":"_ghost-btn--small_qw2vz_206","ghost-btn--large":"_ghost-btn--large_qw2vz_214","ghost-btn--icon-only":"_ghost-btn--icon-only_qw2vz_225","ghost-btn--borderless":"_ghost-btn--borderless_qw2vz_253","ghost-btn--full-width":"_ghost-btn--full-width_qw2vz_265","ghost-btn__icon":"_ghost-btn__icon_qw2vz_273","ghost-btn__icon-svg":"_ghost-btn__icon-svg_qw2vz_280","ghost-btn__label":"_ghost-btn__label_qw2vz_305","ghost-btn__spinner":"_ghost-btn__spinner_qw2vz_315","ghost-btn-spin":"_ghost-btn-spin_qw2vz_1"},a=({variant:c="ghost",label:B="Label",size:Fe="default",type:Ae="button",leadingIcon:v,showLeadingIcon:De=!1,trailingIcon:G,showTrailingIcon:Ue=!1,iconOnly:r=!1,borderless:Se=!1,loading:d=!1,disabled:L=!1,fullWidth:Pe=!1,onClick:Ee,className:qe="",ariaLabel:_})=>{const Ce=[o["ghost-btn"],o[`ghost-btn--${c}`],o[`ghost-btn--${Fe}`],r?o["ghost-btn--icon-only"]:"",r&&Se?o["ghost-btn--borderless"]:"",d?o["ghost-btn--loading"]:"",L?o["ghost-btn--disabled"]:"",Pe?o["ghost-btn--full-width"]:"",qe].filter(Boolean).join(" "),j=d,We=De&&v&&!j;return e.jsxs("button",{type:Ae,className:Ce,onClick:!L&&!d?Ee:void 0,disabled:L||d,"aria-label":r?_??B:_,"aria-busy":d||void 0,children:[j&&e.jsx("span",{className:o["ghost-btn__spinner"],"aria-hidden":"true"}),We&&e.jsx("span",{className:o["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(v,{className:o["ghost-btn__icon-svg"]})}),!r&&e.jsx("span",{className:o["ghost-btn__label"],children:B}),Ue&&G&&!r&&e.jsx("span",{className:o["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(G,{className:o["ghost-btn__icon-svg"]})}),r&&!j&&v&&e.jsx("span",{className:o["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(v,{className:o["ghost-btn__icon-svg"]})})]})};a.__docgenInfo={description:`GhostButton — Low-emphasis interactive control with ghost/outline or link style.
...
}`,...(D=(A=z.parameters)==null?void 0:A.docs)==null?void 0:D.source}}};var U,S,P,E,q;g.parameters={...g.parameters,docs:{...(U=g.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    variant: 'ghost',
    label: 'Label',
    size: 'default',
...
}`,...(P=(S=g.parameters)==null?void 0:S.docs)==null?void 0:P.source},description:{story:"Default ghost button — bordered, light blue-50 background, with leading + trailing icons.\nMatches the Figma `special=alt` default state.",...(q=(E=g.parameters)==null?void 0:E.docs)==null?void 0:q.description}}};var C,W,V,M,N;b.parameters={...b.parameters,docs:{...(C=b.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
...
}`,...(V=(W=b.parameters)==null?void 0:W.docs)==null?void 0:V.source},description:{story:"All four sizes of the ghost variant, with trailing icon.",...(N=(M=b.parameters)==null?void 0:M.docs)==null?void 0:N.description}}};var R,H,X,$,J;p.parameters={...p.parameters,docs:{...(R=p.parameters)==null?void 0:R.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
...
}`,...(me=(xe=m.parameters)==null?void 0:xe.docs)==null?void 0:me.source},description:{story:"Loading state — spinner replaces leading icon.",...(ye=(we=m.parameters)==null?void 0:we.docs)==null?void 0:ye.description}}};var ve,ze,fe,Le,je;w.parameters={...w.parameters,docs:{...(ve=w.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
...
}`,...(fe=(ze=w.parameters)==null?void 0:ze.docs)==null?void 0:fe.source},description:{story:"Disabled state — explicit gray colours, no opacity reduction.",...(je=(Le=w.parameters)==null?void 0:Le.docs)==null?void 0:je.description}}};var Te,ke,Be,Ge,_e;y.parameters={...y.parameters,docs:{...(Te=y.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
Mirrors the full Figma Ghost Button component set.`,...(_e=(Ge=y.parameters)==null?void 0:Ge.docs)==null?void 0:_e.description}}};const Ze=["Documentation","Default","Sizes","WithLeadingIcon","WithTrailingIcon","IconOnly","IconOnlyBorderless","LinkVariant","Loading","Disabled","AllVariants"];export{y as AllVariants,g as Default,w as Disabled,z as Documentation,h as IconOnly,I as IconOnlyBorderless,x as LinkVariant,m as Loading,b as Sizes,p as WithLeadingIcon,u as WithTrailingIcon,Ze as __namedExportsOrder,Ye as default};
