import{j as e}from"./iframe-BpR-ABr4.js";import{D as l}from"./DocsTemplate-BNqP843p.js";import{A as i,P as n}from"./ArrowForward-D02XslKq.js";import{C as j}from"./Check-CpksOBWf.js";import{D as Fe,A as L}from"./Download-Du2NVmsE.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-BadD2Nn7.js";const Ee="_btn_6osjd_17",Ve="_btn__icon_6osjd_167",qe="_btn__label_6osjd_193",Ne="_btn__spinner_6osjd_200",o={btn:Ee,"btn--small":"_btn--small_6osjd_49","btn--large":"_btn--large_6osjd_56","btn--filled":"_btn--filled_6osjd_64","btn--disabled":"_btn--disabled_6osjd_71","btn--outline":"_btn--outline_6osjd_89","btn--loading":"_btn--loading_6osjd_137","btn--icon-only":"_btn--icon-only_6osjd_144","btn--full-width":"_btn--full-width_6osjd_162",btn__icon:Ve,"btn__icon-svg":"_btn__icon-svg_6osjd_174",btn__label:qe,btn__spinner:Ne,"btn-spin":"_btn-spin_6osjd_1"},a=({label:t="Label",variant:De="filled",size:Se="default",type:ke="button",leadingIcon:y,showLeadingIcon:Ae=!1,trailingIcon:T,showTrailingIcon:Oe=!1,iconOnly:r=!1,loading:s=!1,disabled:w=!1,fullWidth:We=!1,onClick:Ce,className:Ue="",ariaLabel:B})=>{const Pe=[o.btn,o[`btn--${De}`],o[`btn--${Se}`],r?o["btn--icon-only"]:"",s?o["btn--loading"]:"",w?o["btn--disabled"]:"",We?o["btn--full-width"]:"",Ue].filter(Boolean).join(" "),v=s,He=Ae&&y&&!v;return e.jsxs("button",{type:ke,className:Pe,onClick:!w&&!s?Ce:void 0,disabled:w||s,"aria-label":r?B??t:B,"aria-busy":s||void 0,children:[v&&e.jsx("span",{className:o.btn__spinner,"aria-hidden":"true"}),He&&e.jsx("span",{className:o.btn__icon,"aria-hidden":"true",children:e.jsx(y,{className:o["btn__icon-svg"]})}),!r&&e.jsx("span",{className:o.btn__label,children:t}),Oe&&T&&!r&&e.jsx("span",{className:o.btn__icon,"aria-hidden":"true",children:e.jsx(T,{className:o["btn__icon-svg"]})}),r&&!v&&y&&e.jsx("span",{className:o.btn__icon,"aria-hidden":"true",children:e.jsx(y,{className:o["btn__icon-svg"]})})]})};a.__docgenInfo={description:`Button — Primary interactive control for the design system.
...
--btn-filled-shadow
--btn-padding-{size}`,description:"Outer button shell. W: HUG, H: HUG. Min-W: 80, min-H: 52 (large). Corner radius: 4. Fill and border both use color/primary/blue/blue. Stroke width: 0.5. Drop shadow applied by default."},{id:2,name:"Leading Icon",token:`filled/icons (user category)
...
}`,...(D=(F=d.parameters)==null?void 0:F.docs)==null?void 0:D.source},description:{story:"Full documentation page for the Button component.",...(k=(S=d.parameters)==null?void 0:S.docs)==null?void 0:k.description}}};var A,O,W,C,U;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    variant: 'filled',
    size: 'default'
  }
}`,...(W=(O=c.parameters)==null?void 0:O.docs)==null?void 0:W.source},description:{story:"Default button — filled variant with label.",...(U=(C=c.parameters)==null?void 0:C.docs)==null?void 0:U.description}}};var P,H,E,V,q;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    gap: '12px',
