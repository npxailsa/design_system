import{r as u,j as e,R as ee}from"./vendor-react-DbhTI_a3.js";import{ax as ce,s as pe}from"./vendor-mui-icons--gk6VE72.js";import{G as ue}from"./GhostButton-ZOCwuL9p.js";import{I as me}from"./vendor-mui-core-CjcFYzit.js";import{D as i}from"./DocsTemplate-IhRQ5m1Q.js";import"../vite-inject-mocker-entry.js";import"./vendor-misc-BD0vWy5z.js";import"./vendor-emotion-DfrZ-FAO.js";const he="_field_1kvh6_8",fe="_label_1kvh6_24",xe="_control_1kvh6_38",ge="_inputRoot_1kvh6_102",ve="_nativeInput_1kvh6_111",ye="_ampmSlot_1kvh6_164",be="_ampmBtn_1kvh6_174",je="_trailingIcon_1kvh6_192",we="_iconSvg_1kvh6_222",Te="_helper_1kvh6_247",r={field:he,"field--small":"_field--small_1kvh6_18","field--default":"_field--default_1kvh6_19","field--large":"_field--large_1kvh6_20",label:fe,control:xe,"control--small":"_control--small_1kvh6_53","control--default":"_control--default_1kvh6_59","control--large":"_control--large_1kvh6_65","control--focused":"_control--focused_1kvh6_72","control--error":"_control--error_1kvh6_78","control--warning":"_control--warning_1kvh6_83","control--success":"_control--success_1kvh6_88","control--disabled":"_control--disabled_1kvh6_93",inputRoot:ge,nativeInput:ve,ampmSlot:ye,ampmBtn:be,trailingIcon:je,"trailingIcon--focused":"_trailingIcon--focused_1kvh6_202","trailingIcon--error":"_trailingIcon--error_1kvh6_206","trailingIcon--warning":"_trailingIcon--warning_1kvh6_210","trailingIcon--success":"_trailingIcon--success_1kvh6_214","trailingIcon--disabled":"_trailingIcon--disabled_1kvh6_218",iconSvg:we,helper:Te,"helper--error":"_helper--error_1kvh6_254","helper--warning":"_helper--warning_1kvh6_258","helper--success":"_helper--success_1kvh6_262"},De=["JAN","FEB","MAR","APR","MAY","JUN","JUL","AUG","SEP","OCT","NOV","DEC"];function Se(t){if(!t)return"";const a=t.split("-");if(a.length!==3)return t;const[s,l,o]=a,d=parseInt(l,10)-1;return d<0||d>11?t:`${o.padStart(2,"0")} / ${De[d]} / ${s}`}function _e(t){if(!t)return"";const a=t.split(":");if(a.length<2)return t;let s=parseInt(a[0],10);const l=a[1].padStart(2,"0"),o=(a[2]||"00").substring(0,2).padStart(2,"0");return s=s%12||12,`${String(s).padStart(2,"0")} : ${l} : ${o}`}function Ie(t){return t&&parseInt(t.split(":")[0],10)>=12?"PM":"AM"}function ke(t,a){if(!t)return t;const s=t.split(":");let l=parseInt(s[0],10);return a==="AM"?l=(l+12)%24:(l=l-12,l<0&&(l=0)),s[0]=String(l).padStart(2,"0"),s.join(":")}const n=({type:t="date",label:a,value:s="",onChange:l,size:o="default",state:d="default",helperText:p,disabled:c=!1,id:M,name:D,className:S,ariaLabel:_})=>{const I=u.useId(),z=M??I,V=u.useRef(null),[x,F]=u.useState(!1),k=Ie(s),ae=t==="date"?"DD / MMM / YYYY":"HH : MM : SS",le=s?x?s:t==="date"?Se(s):_e(s):"",ie=x?t:"text",se=m=>{m.stopPropagation(),!c&&s&&(l==null||l(ke(s,k)))},re=[r.field,r[`field--${o}`],S].filter(Boolean).join(" "),ne=[r.control,r[`control--${o}`],x&&r["control--focused"],d!=="default"&&r[`control--${d}`],c&&r["control--disabled"],t==="time"&&r["control--time"]].filter(Boolean).join(" "),de=[r.trailingIcon,x&&r["trailingIcon--focused"],d!=="default"&&r[`trailingIcon--${d}`],c&&r["trailingIcon--disabled"]].filter(Boolean).join(" "),oe=t==="date"?ce:pe;return e.jsxs("div",{className:re,children:[a&&e.jsx("label",{htmlFor:z,className:r.label,children:a}),e.jsxs("div",{className:ne,onClick:()=>{var m;c||(m=V.current)==null||m.focus()},children:[e.jsx(me,{id:z,inputRef:V,value:le,onChange:m=>l==null?void 0:l(m.target.value),onFocus:()=>F(!0),onBlur:()=>F(!1),placeholder:ae,disabled:c,type:ie,name:D,inputProps:{"aria-label":_??a,className:r.nativeInput},classes:{root:r.inputRoot,input:r.nativeInput}}),t==="time"&&e.jsx("span",{className:r.ampmSlot,onClick:m=>m.stopPropagation(),children:e.jsx(ue,{label:k,size:"extra-small",variant:"ghost",disabled:c,onClick:se,ariaLabel:`Switch to ${k==="AM"?"PM":"AM"}`,className:r.ampmBtn})}),e.jsx("span",{className:de,"aria-hidden":"true",children:e.jsx(oe,{className:r.iconSvg})})]}),p&&e.jsx("span",{className:[r.helper,d!=="default"&&r[`helper--${d}`]].filter(Boolean).join(" "),role:d==="error"?"alert":void 0,children:p})]})};n.__docgenInfo={description:`DateTime — a date or time input built on MUI's \`InputBase\`.
...
}`,...(B=(C=g.parameters)==null?void 0:C.docs)==null?void 0:B.source}}};var P,$,W;v.parameters={...v.parameters,docs:{...(P=v.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: 'Playground',
  render: args => {
...
}`,...(W=($=v.parameters)==null?void 0:$.docs)==null?void 0:W.source}}};var H,N,R;y.parameters={...y.parameters,docs:{...(H=y.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: 'Default',
  render: () => <div style={{
    display: 'flex',
    gap: 24,
...
}`,...(Z=(X=T.parameters)==null?void 0:X.docs)==null?void 0:Z.source}}};const We=["Documentation","Playground","Default","Sizes","States","AllInputStates","Disabled"];export{w as AllInputStates,y as Default,T as Disabled,g as Documentation,v as Playground,b as Sizes,j as States,We as __namedExportsOrder,$e as default};
