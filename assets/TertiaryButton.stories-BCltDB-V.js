import{j as e}from"./iframe-Cxm11g3L.js";import{D as n}from"./DocsTemplate-ImqBBkcI.js";import{B as We}from"./Button-CieCoTYL.js";import{S as Ve}from"./SecondaryButton-BDjzDjgz.js";import{A as r,P as l}from"./ArrowForward-Dv_Drdyw.js";import{C as B}from"./Check-B5DA37oc.js";import{A as _,D as Ne}from"./Download-C3ejEfnd.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-DkEWRx2w.js";const qe="_btn_zj38n_21",Me="_btn__icon_zj38n_221",Re="_btn__label_zj38n_248",He="_btn__spinner_zj38n_255",i={btn:qe,"btn--extra-small":"_btn--extra-small_zj38n_68","btn--small":"_btn--small_zj38n_77","btn--default":"_btn--default_zj38n_85","btn--large":"_btn--large_zj38n_89","btn--solid":"_btn--solid_zj38n_98","btn--disabled":"_btn--disabled_zj38n_102","btn--alt":"_btn--alt_zj38n_129","btn--icon-only":"_btn--icon-only_zj38n_151","btn--loading":"_btn--loading_zj38n_209","btn--full-width":"_btn--full-width_zj38n_216",btn__icon:Me,"btn__icon-svg":"_btn__icon-svg_zj38n_228",btn__label:Re,btn__spinner:He,"tertiary-btn-spin":"_tertiary-btn-spin_zj38n_1"},a=({label:t="Label",variant:o="solid",size:ke="default",type:De="button",leadingIcon:v,showLeadingIcon:Fe=!1,trailingIcon:T,showTrailingIcon:Ae=!1,iconOnly:s=!1,loading:d=!1,disabled:w=!1,fullWidth:Ce=!1,onClick:Ee,className:Pe="",ariaLabel:L})=>{const Oe=[i.btn,s?i["btn--icon-only"]:i[`btn--${o}`],i[`btn--${ke}`],d?i["btn--loading"]:"",w?i["btn--disabled"]:"",Ce?i["btn--full-width"]:"",Pe].filter(Boolean).join(" "),j=d,Ue=Fe&&v&&!j;return e.jsxs("button",{type:De,className:Oe,onClick:!w&&!d?Ee:void 0,disabled:w||d,"aria-label":s?L??t:L,"aria-busy":d||void 0,children:[j&&e.jsx("span",{className:i.btn__spinner,"aria-hidden":"true"}),Ue&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(v,{className:i["btn__icon-svg"]})}),!s&&e.jsx("span",{className:i.btn__label,children:t}),Ae&&T&&!s&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(T,{className:i["btn__icon-svg"]})}),s&&!j&&v&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(v,{className:i["btn__icon-svg"]})})]})};a.__docgenInfo={description:`Tertiary Button — Yellow/amber button for tertiary-level actions.
...
}`,...(D=(k=c.parameters)==null?void 0:k.docs)==null?void 0:D.source},description:{story:"Full documentation page for the Tertiary Button component.",...(A=(F=c.parameters)==null?void 0:F.docs)==null?void 0:A.description}}};var C,E,P,O,U;g.parameters={...g.parameters,docs:{...(C=g.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    variant: 'solid',
    size: 'default'
  }
}`,...(P=(E=g.parameters)==null?void 0:E.docs)==null?void 0:P.source},description:{story:"Default tertiary button — solid variant with label.",...(U=(O=g.parameters)==null?void 0:O.docs)==null?void 0:U.description}}};var W,V,N,q,M;p.parameters={...p.parameters,docs:{...(W=p.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
...
}`,...(ye=(xe=h.parameters)==null?void 0:xe.docs)==null?void 0:ye.source},description:{story:"Loading state — spinner replaces the leading icon.",...(fe=(he=h.parameters)==null?void 0:he.docs)==null?void 0:fe.description}}};var Ie,ve,we,je,ze;f.parameters={...f.parameters,docs:{...(Ie=f.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
...
}`,...(we=(ve=f.parameters)==null?void 0:ve.docs)==null?void 0:we.source},description:{story:"Disabled state.",...(ze=(je=f.parameters)==null?void 0:je.docs)==null?void 0:ze.description}}};var Te,Le,Be,_e,Se;I.parameters={...I.parameters,docs:{...(Te=I.parameters)==null?void 0:Te.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(Be=(Le=I.parameters)==null?void 0:Le.docs)==null?void 0:Be.source},description:{story:"Full variant, size, and state matrix.",...(Se=(_e=I.parameters)==null?void 0:_e.docs)==null?void 0:Se.description}}};const la=["Documentation","Default","Variants","Sizes","WithLeadingIcon","WithTrailingIcon","WithBothIcons","IconOnly","Loading","Disabled","AllVariants"];export{I as AllVariants,g as Default,f as Disabled,c as Documentation,y as IconOnly,h as Loading,b as Sizes,p as Variants,x as WithBothIcons,u as WithLeadingIcon,m as WithTrailingIcon,la as __namedExportsOrder,aa as default};
