...
<AutoSaveTagButton status="disabled" timestamp="12:30 PM on 15 JAN 2025" />`}),a.jsxs(e.Principles,{children:[a.jsxs(e.PrincipleCard,{number:1,title:"Keep the timestamp accurate",children:["Update the ",a.jsx("code",{children:"timestamp"})," prop whenever the save completes. The tag should always reflect the most recent successful save, not the current time."]}),a.jsx(e.PrincipleCard,{number:2,title:"Persist the button across all states",children:"Keep the component visible in all states including saved and error. Hiding it removes important feedback about save status."}),a.jsx(e.PrincipleCard,{number:3,title:"One per form or document scope",children:"Use a single AutoSaveTagButton per document or form. Multiple instances suggest multiple save targets, which is confusing."})]}),a.jsx(e.Footer,{})]});h.__docgenInfo={description:"",methods:[],displayName:"AutoSaveTagButtonDocs"};const Q=["default","auto-saving","saving","saved","error","disabled","focused"],ca={title:"Atoms/Buttons/Auto-Save Tag Button",component:o,parameters:{docs:{page:()=>a.jsx(h,{})}},argTypes:{status:{control:"select",options:Q,description:"Drives the label, background, border, and text colour of the pill button"},label:{control:"text",description:"Overrides the auto-derived label for the current status"},timestamp:{control:"text",description:"Timestamp text displayed in the tag below the button"},showTag:{control:"boolean",description:"Toggle the timestamp tag visibility"}},args:{status:"default",timestamp:"12:30 PM on 15 JAN 2025",showTag:!0}},n={render:()=>a.jsx(h,{}),parameters:{controls:{disable:!0},actions:{disable:!0},chromatic:{disableSnapshot:!0}}},i={args:{status:"default"}},l={name:"Auto-saving",args:{status:"auto-saving"}},d={args:{status:"saving"}},u={args:{status:"saved"}},g={args:{status:"error"}},c={args:{status:"disabled"}},p={args:{status:"focused"}},v={name:"Without Tag",args:{status:"default",showTag:!1}},b={name:"All States",render:()=>a.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-32px)",padding:"var(--global-spacing-sizing-24px)",alignItems:"flex-start"},children:Q.map(t=>a.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"var(--global-spacing-sizing-32px)"},children:[a.jsx(o,{status:t,timestamp:"12:30 PM on 15 JAN 2025"}),a.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-xs)",color:"var(--global-color-neutral-gray-500)",textTransform:"capitalize",paddingTop:"var(--global-spacing-sizing-12px)"},children:t})]},t))}),parameters:{controls:{disable:!0}}};var _,y,S;n.parameters={...n.parameters,docs:{...(_=n.parameters)==null?void 0:_.docs,source:{originalSource:`{
