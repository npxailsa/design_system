...
// options.length === 1  → position="solo"`}),e.jsxs(i.Principles,{children:[e.jsx(i.PrincipleCard,{number:1,title:"Clear Selection State",children:"The selected state uses the brand primary background colour and white text for immediate visual confirmation. Checked indicators invert on selected rows so they remain visible against the blue background."}),e.jsxs(i.PrincipleCard,{number:2,title:"Accessible by Default",children:["Built on MUI ButtonBase with ",e.jsx("code",{children:'role="option"'}),","," ",e.jsx("code",{children:"aria-selected"}),", and ",e.jsx("code",{children:"aria-disabled"}),". Keyboard navigation and focus-visible rings are handled automatically."]}),e.jsx(i.PrincipleCard,{number:3,title:"Position-Aware Stacking",children:"The position prop collapses internal borders and adjusts border-radius so a stack of options reads as a single cohesive menu panel rather than a series of separate elements."})]}),e.jsx(i.DosDonts,{doItem:{icon:e.jsxs("div",{style:{display:"flex",flexDirection:"column",width:"140px"},children:[e.jsx(t,{label:"Option A",position:"top",selectionType:"checkbox"}),e.jsx(t,{label:"Option B",position:"mid",selectionType:"checkbox",selected:!0}),e.jsx(t,{label:"Option C",position:"bottom",selectionType:"checkbox"})]}),label:"Stack with position",description:"Use the position prop to stack options into a unified panel with collapsed borders and appropriate radius."},dontItem:{icon:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"4px",width:"140px"},children:[e.jsx(t,{label:"Option A",position:"solo",selectionType:"checkbox"}),e.jsx(t,{label:"Option B",position:"solo",selectionType:"checkbox",selected:!0})]}),label:"Stack with solo",description:"Don't use solo position for every item in a stack — it creates floating separate cards instead of a unified menu."}}),e.jsx(i.RelatedLinks,{links:[{label:"ButtonMenuItem",href:"?path=/story/foundation-buildingblocks-buttonmenu--documentation"},{label:"Dropdown",href:"?path=/story/atoms-input-dropdown--documentation"}]}),e.jsx(i.Footer,{componentName:"SelectOption"})]});k.__docgenInfo={description:"",methods:[],displayName:"SelectOptionDocs"};const we={title:"Foundation/BuildingBlocks/SelectOption",component:t,parameters:{docs:{page:()=>e.jsx(k,{})}},argTypes:{size:{control:"select",options:["small","default","large"],description:"Controls padding, font size, and indicator dimensions"},position:{control:"select",options:["top","mid","bottom","solo"],description:"Controls border-radius and which border edges are rendered"},selectionType:{control:"select",options:["none","checkbox","radio"],description:"Which selection indicator to render alongside the label"},selected:{control:"boolean",description:"Whether this option is currently selected/checked"},disabled:{control:"boolean",description:"Prevents interaction and renders in a muted style"},label:{control:"text",description:"Visible label text"}},args:{label:"Option label",size:"default",position:"solo",selectionType:"none",selected:!1,disabled:!1}},p={name:"Documentation",render:()=>e.jsx(k,{}),parameters:{controls:{disable:!0},actions:{disable:!0},layout:"fullscreen",chromatic:{disableSnapshot:!0}}},m={name:"Playground",render:o=>e.jsx("div",{style:{maxWidth:"320px",padding:"24px"},children:e.jsx(t,{...o})})},x={name:"Default",render:()=>e.jsx("div",{style:{maxWidth:"280px",padding:"24px"},children:e.jsx(t,{label:"Option label",position:"solo"})}),parameters:{controls:{disable:!0}}},b={name:"Sizes",render:()=>{const o=["small","default","large"];return e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"24px",padding:"24px",maxWidth:"360px"},children:o.map(n=>e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"11px",fontWeight:600,color:"var(--global-color-neutral-gray-500)",textTransform:"capitalize",marginBottom:"6px"},children:n}),e.jsx(t,{label:`Option label — ${n}`,size:n,position:"solo"})]},n))})},parameters:{controls:{disable:!0}}},u={name:"Status — Plain",render:()=>e.jsxs("div",{style:{maxWidth:"280px",padding:"24px"},children:[e.jsx(t,{label:"Default option",position:"top"}),e.jsx(t,{label:"Hover (interact to see)",position:"mid"}),e.jsx(t,{label:"Selected option",position:"mid",selected:!0}),e.jsx(t,{label:"Disabled option",position:"bottom",disabled:!0})]}),parameters:{controls:{disable:!0}}},h={name:"Status — Checkbox",render:()=>{const o=()=>{const[n,s]=le.useState(new Set(["Option B"])),a=["Option A","Option B","Option C","Option D (disabled)"];return e.jsx("div",{style:{maxWidth:"280px",padding:"24px"},children:a.map((l,r)=>{const d=l.includes("disabled"),j=r===0?"top":r===a.length-1?"bottom":"mid";return e.jsx(t,{label:l,position:j,selectionType:"checkbox",selected:n.has(l),disabled:d,onClick:()=>{d||s(ne=>{const c=new Set(ne);return c.has(l)?c.delete(l):c.add(l),c})}},l)})})};return e.jsx(o,{})},parameters:{controls:{disable:!0}}},g={name:"Status — Radio",render:()=>{const o=()=>{const[n,s]=le.useState("Option B"),a=["Option A","Option B","Option C","Option D (disabled)"];return e.jsx("div",{style:{maxWidth:"280px",padding:"24px"},children:a.map((l,r)=>{const d=l.includes("disabled"),j=r===0?"top":r===a.length-1?"bottom":"mid";return e.jsx(t,{label:l,position:j,selectionType:"radio",selected:n===l,disabled:d,onClick:()=>{d||s(l)}},l)})})};return e.jsx(o,{})},parameters:{controls:{disable:!0}}},y={name:"Status — Disabled",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"16px",padding:"24px",maxWidth:"320px"},children:["none","checkbox","radio"].map(o=>e.jsxs("div",{children:[e.jsxs("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"11px",fontWeight:600,color:"var(--global-color-neutral-gray-500)",marginBottom:"6px"},children:['selectionType="',o,'" — disabled']}),e.jsx(t,{label:"Disabled option",selectionType:o,disabled:!0,position:"solo"})]},o))}),parameters:{controls:{disable:!0}}},v={name:"Component Breakdown",render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"32px",padding:"24px"},children:[e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"12px",fontWeight:600,color:"var(--global-color-neutral-gray-500)",marginBottom:"8px"},children:"Position Variants (stacked)"}),e.jsx("div",{style:{maxWidth:"280px"},children:["top","mid","bottom"].map((o,n)=>e.jsx(t,{label:`Position: "${o}"`,position:o,selectionType:"checkbox",selected:n===1},o))})]}),e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"12px",fontWeight:600,color:"var(--global-color-neutral-gray-500)",marginBottom:"8px"},children:"Selection Types (solo)"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"6px",maxWidth:"280px"},children:["none","checkbox","radio"].map(o=>e.jsx(t,{label:`selectionType="${o}"`,selectionType:o,position:"solo"},o))})]}),e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"12px",fontWeight:600,color:"var(--global-color-neutral-gray-500)",marginBottom:"8px"},children:"Sizes"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"6px",maxWidth:"280px"},children:["small","default","large"].map(o=>e.jsx(t,{label:`size="${o}"`,size:o,position:"solo",selectionType:"radio"},o))})]})]}),parameters:{controls:{disable:!0}}},f={name:"All Interactive States",render:()=>{const o=[{label:"Default"},{label:"Selected",selected:!0},{label:"Disabled",disabled:!0},{label:"Disabled + Selected",disabled:!0,selected:!0}];return e.jsx("div",{style:{display:"flex",gap:"32px",padding:"24px",flexWrap:"wrap"},children:["none","checkbox","radio"].map(n=>e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"11px",fontWeight:600,color:"var(--global-color-neutral-gray-500)",marginBottom:"8px",textTransform:"capitalize"},children:n==="none"?"Plain":n}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"6px",minWidth:"200px"},children:o.map(s=>e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"var(--brand-font-secondary)",fontSize:"10px",color:"var(--global-color-neutral-gray-400)",marginBottom:"2px"},children:s.label}),e.jsx(t,{label:s.label,selectionType:n,selected:s.selected,disabled:s.disabled,position:"solo"})]},s.label))})]},n))})},parameters:{controls:{disable:!0}}},S={name:"Full Design Matrix",render:()=>{const o=["small","default","large"],n=["none","checkbox","radio"],s=[{label:"Default"},{label:"Selected",selected:!0},{label:"Disabled",disabled:!0}];return e.jsx("div",{style:{padding:"24px",overflowX:"auto"},children:o.map(a=>e.jsxs("div",{style:{marginBottom:"40px"},children:[e.jsxs("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"13px",fontWeight:600,color:"var(--global-color-neutral-gray-700)",marginBottom:"12px",textTransform:"capitalize"},children:["Size: ",a]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:`120px repeat(${s.length}, 1fr)`,gap:"8px",alignItems:"center"},children:[e.jsx("div",{}),s.map(l=>e.jsx("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"11px",fontWeight:600,color:"var(--global-color-neutral-gray-500)",textAlign:"center"},children:l.label},l.label)),n.map(l=>e.jsxs(se.Fragment,{children:[e.jsx("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"11px",color:"var(--global-color-neutral-gray-700)",textTransform:"capitalize"},children:l==="none"?"Plain":l}),s.map(r=>e.jsx(t,{label:"Option",size:a,selectionType:l,selected:r.selected,disabled:r.disabled,position:"solo"},r.label))]},l))]})]},a))})},parameters:{controls:{disable:!0}}};var O,z,T;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: 'Documentation',
...
}`,...(T=(z=p.parameters)==null?void 0:z.docs)==null?void 0:T.source}}};var w,B,W;m.parameters={...m.parameters,docs:{...(w=m.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: 'Playground',
...
}`,...(W=(B=m.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};var C,F,P;x.parameters={...x.parameters,docs:{...(C=x.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: 'Default',
  render: () => <div style={{
    maxWidth: '280px',
    padding: '24px'
...
}`,...(P=(F=x.parameters)==null?void 0:F.docs)==null?void 0:P.source}}};var A,I,M;b.parameters={...b.parameters,docs:{...(A=b.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: 'Sizes',
  render: () => {
...
}`,...(M=(I=b.parameters)==null?void 0:I.docs)==null?void 0:M.source}}};var R,U,$;u.parameters={...u.parameters,docs:{...(R=u.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: 'Status — Plain',
  render: () => <div style={{
    maxWidth: '280px',
    padding: '24px'
...
}`,...($=(U=u.parameters)==null?void 0:U.docs)==null?void 0:$.source}}};var E,H,_;h.parameters={...h.parameters,docs:{...(E=h.parameters)==null?void 0:E.docs,source:{originalSource:`{
...
}`,...(K=(X=y.parameters)==null?void 0:X.docs)==null?void 0:K.source}}};var Y,Z,q;v.parameters={...v.parameters,docs:{...(Y=v.parameters)==null?void 0:Y.docs,source:{originalSource:`{
...
}`,...(q=(Z=v.parameters)==null?void 0:Z.docs)==null?void 0:q.source}}};var J,Q,ee;f.parameters={...f.parameters,docs:{...(J=f.parameters)==null?void 0:J.docs,source:{originalSource:`{
...
}`,...(ee=(Q=f.parameters)==null?void 0:Q.docs)==null?void 0:ee.source}}};var oe,te,ie;S.parameters={...S.parameters,docs:{...(oe=S.parameters)==null?void 0:oe.docs,source:{originalSource:`{
...
}`,...(ie=(te=S.parameters)==null?void 0:te.docs)==null?void 0:ie.source}}};const Be=["Documentation","Playground","Default","Sizes","StatusPlain","StatusCheckbox","StatusRadio","StatusDisabled","ComponentBreakdown","AllInteractiveStates","FullDesignMatrix"];export{f as AllInteractiveStates,v as ComponentBreakdown,x as Default,p as Documentation,S as FullDesignMatrix,m as Playground,b as Sizes,h as StatusCheckbox,y as StatusDisabled,u as StatusPlain,g as StatusRadio,Be as __namedExportsOrder,we as default};
