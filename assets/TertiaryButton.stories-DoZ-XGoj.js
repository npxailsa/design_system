import{j as e}from"./iframe-4u8gsPl3.js";import{D as n}from"./DocsTemplate-D1pNB2Ba.js";import{B as We}from"./Button-DY0e4Bhd.js";import{S as Ve}from"./SecondaryButton-MHrFRgjJ.js";import{A as r,P as l}from"./ArrowForward-kaR6kcMC.js";import{C as B}from"./Check-DnHY-ZsF.js";import{A as _,D as Ne}from"./Download-Br2Hf6JI.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-tobnP7T0.js";const qe="_btn_r75go_21",Me="_btn__icon_r75go_209",Re="_btn__label_r75go_236",He="_btn__spinner_r75go_243",i={btn:qe,"btn--extra-small":"_btn--extra-small_r75go_56","btn--small":"_btn--small_r75go_65","btn--default":"_btn--default_r75go_73","btn--large":"_btn--large_r75go_77","btn--solid":"_btn--solid_r75go_86","btn--disabled":"_btn--disabled_r75go_90","btn--alt":"_btn--alt_r75go_117","btn--icon-only":"_btn--icon-only_r75go_139","btn--loading":"_btn--loading_r75go_197","btn--full-width":"_btn--full-width_r75go_204",btn__icon:Me,"btn__icon-svg":"_btn__icon-svg_r75go_216",btn__label:Re,btn__spinner:He,"tertiary-btn-spin":"_tertiary-btn-spin_r75go_1"},a=({label:t="Label",variant:o="solid",size:ke="default",type:De="button",leadingIcon:v,showLeadingIcon:Fe=!1,trailingIcon:z,showTrailingIcon:Ae=!1,iconOnly:s=!1,loading:d=!1,disabled:w=!1,fullWidth:Ce=!1,onClick:Ee,className:Pe="",ariaLabel:L})=>{const Oe=[i.btn,s?i["btn--icon-only"]:i[`btn--${o}`],i[`btn--${ke}`],d?i["btn--loading"]:"",w?i["btn--disabled"]:"",Ce?i["btn--full-width"]:"",Pe].filter(Boolean).join(" "),j=d,Ue=Fe&&v&&!j;return e.jsxs("button",{type:De,className:Oe,onClick:!w&&!d?Ee:void 0,disabled:w||d,"aria-label":s?L??t:L,"aria-busy":d||void 0,children:[j&&e.jsx("span",{className:i.btn__spinner,"aria-hidden":"true"}),Ue&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(v,{className:i["btn__icon-svg"]})}),!s&&e.jsx("span",{className:i.btn__label,children:t}),Ae&&z&&!s&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(z,{className:i["btn__icon-svg"]})}),s&&!j&&v&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(v,{className:i["btn__icon-svg"]})})]})};a.__docgenInfo={description:`Tertiary Button — Yellow/amber button for tertiary-level actions.
...
}`,...(ye=(xe=h.parameters)==null?void 0:xe.docs)==null?void 0:ye.source},description:{story:"Loading state — spinner replaces the leading icon.",...(fe=(he=h.parameters)==null?void 0:he.docs)==null?void 0:fe.description}}};var Ie,ve,we,je,Te;f.parameters={...f.parameters,docs:{...(Ie=f.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
...
}`,...(we=(ve=f.parameters)==null?void 0:ve.docs)==null?void 0:we.source},description:{story:"Disabled state.",...(Te=(je=f.parameters)==null?void 0:je.docs)==null?void 0:Te.description}}};var ze,Le,Be,_e,Se;I.parameters={...I.parameters,docs:{...(ze=I.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
