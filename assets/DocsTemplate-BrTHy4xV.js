import{j as e}from"./iframe-DBOJ2IMB.js";import{useMDXComponents as t}from"./index-CNhyF4eP.js";import{M as c}from"./blocks-BIH_T9kU.js";import"./preload-helper-Dp1pzeXC.js";import"./index-wxQWg9Tt.js";function s(o){const n={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...o.components};return e.jsxs(e.Fragment,{children:[`
`,`
`,e.jsx(c,{title:"Foundation/DocsTemplate/Usage Guide"}),`
...
`,e.jsxs(n.p,{children:["See the ",e.jsx(n.strong,{children:"Iconography"})," story under ",e.jsx(n.code,{children:"Foundation/DocsTemplate"})," for a complete example of all sub-components working together to produce a full documentation page."]})]})}function p(o={}){const{wrapper:n}={...t(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{p as default};
