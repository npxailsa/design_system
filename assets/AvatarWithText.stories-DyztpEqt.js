import{j as e,R as se}from"./iframe-BUzXYmAS.js";import{A as oe}from"./Avatar-D8ElDfRX.js";import{D as t}from"./DocsTemplate-DlRFi1bc.js";import"./preload-helper-Dp1pzeXC.js";import"./Person-eyootIUV.js";import"./createSvgIcon-D6JiVpM1.js";import"./StatusIndicator-WEp2GBrq.js";const pe="_root_hb8b4_7",ce="_avatar_hb8b4_21",de="_textCol_hb8b4_26",me="_name_hb8b4_35",ue="_subtext_hb8b4_45",xe="_email_hb8b4_55",r={root:pe,avatar:ce,textCol:de,name:me,subtext:ue,email:xe,"size-large":"_size-large_hb8b4_68","size-default":"_size-default_hb8b4_73","size-small":"_size-small_hb8b4_78","size-x-small":"_size-x-small_hb8b4_83"},l=({variant:a="name-only",size:p="default",shape:A="circle",avatarType:j="profile-photo",statusIcon:S=!1,border:W=!1,name:c="Willow Quinn",subtext:d="Additional subtext (e.g role)",email:m="willowquin@email.com",initials:te="WQ",src:le,alt:re,className:ie=""})=>{const ne=[r.root,r[`size-${p}`],r[`variant-${a}`],ie].filter(Boolean).join(" ");return e.jsxs("div",{className:ne,children:[e.jsx(oe,{type:j,size:p,shape:A,border:W,statusIcon:S,initials:te,src:le,alt:re??c,className:r.avatar}),e.jsxs("div",{className:r.textCol,children:[e.jsx("span",{className:r.name,children:c}),a==="w-subtext"&&d&&e.jsx("span",{className:r.subtext,children:d}),a==="default"&&m&&e.jsx("span",{className:r.email,children:m})]})]})};l.__docgenInfo={description:`AvatarWithText (horizontal) — combines an Avatar with a text column.
...
}`,...(ae=(ee=z.parameters)==null?void 0:ee.docs)==null?void 0:ae.source}}};const We=["Documentation","Playground","NameOnly","WithSubtext","WithEmail","AllSizesWithSubtext","AllSizesNameOnly","AllSizesWithEmail","AllVariantsAllSizes"];export{b as AllSizesNameOnly,w as AllSizesWithEmail,f as AllSizesWithSubtext,z as AllVariantsAllSizes,x as Documentation,g as NameOnly,h as Playground,v as WithEmail,y as WithSubtext,We as __namedExportsOrder,Se as default};
