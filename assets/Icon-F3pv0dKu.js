import{j as c}from"./iframe-ed3UfVX2.js";const u="_icon_ie810_1",p={icon:u},f=({icon:i,size:e="default",className:t,sx:a,...o})=>{const r={"2x-small":"var(--icon-size-2x-small)","x-small":"var(--icon-size-x-small)",small:"var(--icon-size-small)",default:"var(--icon-size-default)",large:"var(--icon-size-large)","x-large":"var(--icon-size-x-large)","2x-large":"var(--icon-size-2x-large)"},n=typeof e=="string"&&e!=="inherit",l={...typeof a=="object"?a:{},fontSize:typeof e=="number"?`var(--global-spacing-sizing-${e}px)`:n?r[e]:void 0},s=typeof a=="function"?m=>({...a(m),fontSize:l.fontSize}):l;return c.jsx(i,{className:`${p.icon} ${t||""}`,fontSize:n||typeof e=="number"?void 0:e==="inherit"?"inherit":void 0,sx:s,...o})};f.__docgenInfo={description:`A wrapper component for Material UI icons to ensure consistent styling
