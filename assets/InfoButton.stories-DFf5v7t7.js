...
}`,...(J=($=u.parameters)==null?void 0:$.docs)==null?void 0:J.source},description:{story:"Loading state — spinner replaces the leading icon, trailing icon hidden.",...(Q=(K=u.parameters)==null?void 0:K.docs)==null?void 0:Q.description}}};var ee,te,ae,ne,oe;f.parameters={...f.parameters,docs:{...(ee=f.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(ae=(te=f.parameters)==null?void 0:te.docs)==null?void 0:ae.source},description:{story:"Disabled state — grey background, grey text, not interactive.",...(oe=(ne=f.parameters)==null?void 0:ne.docs)==null?void 0:oe.description}}};var ie,se,le,re,de;g.parameters={...g.parameters,docs:{...(ie=g.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '32px',
