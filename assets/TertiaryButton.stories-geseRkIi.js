import{j as e}from"./iframe-DdftltaW.js";import{D as n}from"./DocsTemplate-By0Anvhw.js";import{B as We}from"./Button-tiaHBEU7.js";import{S as Ve}from"./SecondaryButton-DU0RnZRg.js";import{P as l}from"./Person-B4XQKRZw.js";import{A as r}from"./ArrowForward-D3ovAaXL.js";import{C as B}from"./Check-BlhQtOmV.js";import{A as _}from"./Add-BA23JRzW.js";import{D as Ne}from"./Download-Btye4B7F.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-CRGzH3Dl.js";const qe="_btn_1dzsa_21",Me="_btn__icon_1dzsa_223",Re="_btn__label_1dzsa_250",He="_btn__spinner_1dzsa_257",i={btn:qe,"btn--extra-small":"_btn--extra-small_1dzsa_68","btn--small":"_btn--small_1dzsa_77","btn--default":"_btn--default_1dzsa_85","btn--large":"_btn--large_1dzsa_89","btn--solid":"_btn--solid_1dzsa_98","btn--disabled":"_btn--disabled_1dzsa_102","btn--alt":"_btn--alt_1dzsa_131","btn--icon-only":"_btn--icon-only_1dzsa_153","btn--loading":"_btn--loading_1dzsa_211","btn--full-width":"_btn--full-width_1dzsa_218",btn__icon:Me,"btn__icon-svg":"_btn__icon-svg_1dzsa_230",btn__label:Re,btn__spinner:He,"tertiary-btn-spin":"_tertiary-btn-spin_1dzsa_1"},a=({label:o="Label",variant:t="solid",size:ke="default",type:De="button",leadingIcon:v,showLeadingIcon:Fe=!1,trailingIcon:T,showTrailingIcon:Ae=!1,iconOnly:s=!1,loading:d=!1,disabled:w=!1,fullWidth:Ee=!1,onClick:Ce,className:Pe="",ariaLabel:L})=>{const Oe=[i.btn,s?i["btn--icon-only"]:i[`btn--${t}`],i[`btn--${ke}`],d?i["btn--loading"]:"",w?i["btn--disabled"]:"",Ee?i["btn--full-width"]:"",Pe].filter(Boolean).join(" "),z=d,Ue=Fe&&v&&!z;return e.jsxs("button",{type:De,className:Oe,onClick:!w&&!d?Ce:void 0,disabled:w||d,"aria-label":s?L??o:L,"aria-busy":d||void 0,children:[z&&e.jsx("span",{className:i.btn__spinner,"aria-hidden":"true"}),Ue&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(v,{className:i["btn__icon-svg"]})}),!s&&e.jsx("span",{className:i.btn__label,children:o}),Ae&&T&&!s&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(T,{className:i["btn__icon-svg"]})}),s&&!z&&v&&e.jsx("span",{className:i.btn__icon,"aria-hidden":"true",children:e.jsx(v,{className:i["btn__icon-svg"]})})]})};a.__docgenInfo={description:`Tertiary Button — Yellow/amber button for tertiary-level actions.
...
}`,...(le=(ae=m.parameters)==null?void 0:ae.docs)==null?void 0:le.source},description:{story:"Buttons with a trailing icon.",...(re=(ne=m.parameters)==null?void 0:ne.docs)==null?void 0:re.description}}};var ie,oe,te,se,de;x.parameters={...x.parameters,docs:{...(ie=x.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
...
}`,...(te=(oe=x.parameters)==null?void 0:oe.docs)==null?void 0:te.source},description:{story:"Buttons with both leading and trailing icons.",...(de=(se=x.parameters)==null?void 0:se.docs)==null?void 0:de.description}}};var ce,ge,pe,be,ue;y.parameters={...y.parameters,docs:{...(ce=y.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    gap: 'var(--global-spacing-sizing-12px)',
