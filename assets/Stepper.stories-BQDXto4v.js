import{j as e,R as ae}from"./iframe-tPzHIYOl.js";import{S as ne}from"./StepperSteps-CRiGAV7D.js";import{S as ie}from"./StepperLines-KMf5PvQV.js";import{D as s}from"./DocsTemplate-CVO6m3SF.js";import"./preload-helper-Dp1pzeXC.js";const re="_stepper_qmmww_7",oe="_stepWrapper_qmmww_15",pe="_stepItem_qmmww_26",de="_lineWrapper_qmmww_38",ce="_line_qmmww_38",r={stepper:re,stepWrapper:oe,stepItem:pe,lineWrapper:de,"lineWrapper--small":"_lineWrapper--small_qmmww_46","lineWrapper--default":"_lineWrapper--default_qmmww_47","lineWrapper--large":"_lineWrapper--large_qmmww_48",line:ce};function me(t,a){if(t==="complete"){if(a==="complete"||a==="active")return"complete";if(a==="default")return"to-do"}return"disabled"}const l=({steps:t,size:a="default",showLabel:i=!0,lineType:c="solid",lineStroke:g="2-px",className:Z})=>{if(!t||t.length===0)return null;const ee=[r.stepper,Z].filter(Boolean).join(" "),te=[r.lineWrapper,r[`lineWrapper--${a}`]].join(" ");return e.jsx("div",{className:ee,role:"group","aria-label":"Progress steps",children:t.map((m,j)=>{const w=m.state??"default",T=j===t.length-1,se=T?"default":t[j+1].state??"default",le=me(w,se);return e.jsxs(ae.Fragment,{children:[e.jsx("div",{className:r.stepWrapper,children:e.jsx(ne,{steps:[{id:m.id,label:m.label,state:w}],size:a,showLabel:i,className:r.stepItem})}),!T&&e.jsx("div",{className:te,children:e.jsx(ie,{type:c,stroke:g,state:le,className:r.line})})]},m.id)})})};l.__docgenInfo={description:"",methods:[],displayName:"Stepper",props:{steps:{required:!0,tsType:{name:"Array",elements:[{name:"StepperStep"}],raw:"StepperStep[]"},description:"Array of step definitions. Numbers are generated automatically."},size:{required:!1,tsType:{name:"union",raw:"'small' | 'default' | 'large'",elements:[{name:"literal",value:"'small'"},{name:"literal",value:"'default'"},{name:"literal",value:"'large'"}]},description:`Visual size of all step circles and connector lines.
