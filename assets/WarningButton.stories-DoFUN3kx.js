...
}`,...(q=(G=c.parameters)==null?void 0:G.docs)==null?void 0:q.source},description:{story:"Both variants side by side — as they appear in a warning CardContent ButtonGroup.",...(Z=(O=c.parameters)==null?void 0:O.docs)==null?void 0:Z.description}}};var X,Y,$,J,K;b.parameters={...b.parameters,docs:{...(X=b.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...($=(Y=b.parameters)==null?void 0:Y.docs)==null?void 0:$.source},description:{story:"All three sizes — small (34px), default (44px), large (56px).",...(K=(J=b.parameters)==null?void 0:J.docs)==null?void 0:K.description}}};var Q,aa,ea,na,ta;p.parameters={...p.parameters,docs:{...(Q=p.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(ea=(aa=p.parameters)==null?void 0:aa.docs)==null?void 0:ea.source},description:{story:"Loading state — spinner replaces the leading icon, trailing icon is hidden.",...(ta=(na=p.parameters)==null?void 0:na.docs)==null?void 0:ta.description}}};var ra,ia,sa,oa,la;u.parameters={...u.parameters,docs:{...(ra=u.parameters)==null?void 0:ra.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(ca=(ga=h.parameters)==null?void 0:ga.docs)==null?void 0:ca.source},description:{story:"Full state matrix — all combinations of variant × size × state.",...(pa=(ba=h.parameters)==null?void 0:ba.docs)==null?void 0:pa.description}}};const Ha=["Documentation","Playground","Default","Solid","Ghost","BothVariants","Sizes","Loading","Disabled","FullDesignMatrix"];export{c as BothVariants,m as Default,u as Disabled,o as Documentation,h as FullDesignMatrix,g as Ghost,p as Loading,l as Playground,b as Sizes,d as Solid,Ha as __namedExportsOrder,Ma as default};
