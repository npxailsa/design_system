...
// Disabled
<FilterSortButton variant="primary" size="md" label="Filter" disabled />`}),e.jsxs(r.Principles,{children:[e.jsxs(r.PrincipleCard,{number:1,title:"Limit to one primary per toolbar",children:["Use a single ",e.jsx("code",{children:"primary"})," variant button per toolbar to establish a clear visual anchor. Supporting actions should use secondary, tertiary, or ghost variants."]}),e.jsxs(r.PrincipleCard,{number:2,title:"Match the density of the surrounding UI",children:["Choose size based on the context — ",e.jsx("code",{children:"xs"})," and ",e.jsx("code",{children:"sm"})," for dense data grids, ",e.jsx("code",{children:"md"})," for standard toolbars, and ",e.jsx("code",{children:"lg"})," for prominent header controls with generous spacing."]}),e.jsx(r.PrincipleCard,{number:3,title:"Keep labels short and action-oriented",children:'Standard labels are "Filter", "Sort", and "More actions". Custom labels should be short, imperative verbs. Avoid decorative or explanatory text in toolbar buttons.'})]}),e.jsx(r.Footer,{})]});v.__docgenInfo={description:"",methods:[],displayName:"FilterSortButtonDocs"};const o=["primary","secondary","tertiary","ghost"],J=["lg","md","sm","xs"],oe=["Filter","Sort","More actions"],be={title:"Atoms/Buttons/Sort & Filter Button",component:t,parameters:{docs:{page:()=>e.jsx(v,{})}},argTypes:{variant:{control:"select",options:o,description:"Visual colour variant: primary (navy), secondary (sky-blue), tertiary (seafoam), ghost (outline)"},size:{control:"select",options:J,description:"Button size — xs, sm, md, lg"},label:{control:"text",description:"Button label text (Filter / Sort / More actions)"},disabled:{control:"boolean",description:"Disables the button"}},args:{variant:"primary",size:"md",label:"Filter",disabled:!1}},d={name:"Documentation",render:()=>e.jsx(v,{}),parameters:{docs:{page:()=>e.jsx(v,{})}}},p={name:"All Variants",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-24px)"},children:oe.map(a=>e.jsxs("div",{children:[e.jsx("div",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-xs)",fontWeight:"var(--global-type-weight-default)",color:"var(--global-color-neutral-gray-600)",marginBottom:"var(--global-spacing-sizing-12px)",textTransform:"uppercase",letterSpacing:"0.08em"},children:a}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-12px)"},children:o.map(n=>e.jsx("div",{style:{display:"flex",gap:"var(--global-spacing-sizing-12px)",alignItems:"center"},children:J.map(i=>e.jsx(t,{variant:n,size:i,label:a},i))},n))})]},a))})},c={name:"Primary",args:{variant:"primary",label:"Filter"}},m={name:"Secondary",args:{variant:"secondary",label:"Filter"}},b={name:"Tertiary",args:{variant:"tertiary",label:"Filter"}},g={name:"Ghost",args:{variant:"ghost",label:"Filter"}},y={name:"Filter",render:()=>e.jsx("div",{style:{display:"flex",gap:"var(--global-spacing-sizing-8px)",alignItems:"center",flexWrap:"wrap"},children:o.map(a=>e.jsx(t,{variant:a,size:"md",label:"Filter"},a))})},x={name:"Sort",render:()=>e.jsx("div",{style:{display:"flex",gap:"var(--global-spacing-sizing-8px)",alignItems:"center",flexWrap:"wrap"},children:o.map(a=>e.jsx(t,{variant:a,size:"md",label:"Sort"},a))})},u={name:"More Actions",render:()=>e.jsx("div",{style:{display:"flex",gap:"var(--global-spacing-sizing-8px)",alignItems:"center",flexWrap:"wrap"},children:o.map(a=>e.jsx(t,{variant:a,size:"md",label:"More actions"},a))})},f={name:"Disabled",render:()=>e.jsx("div",{style:{display:"flex",gap:"var(--global-spacing-sizing-8px)",alignItems:"center",flexWrap:"wrap"},children:o.map(a=>e.jsx(t,{variant:a,size:"md",label:"Filter",disabled:!0},a))})};var h,z,S;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: 'Documentation',
...
}`,...(P=(E=g.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};var V,N,W;y.parameters={...y.parameters,docs:{...(V=y.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: 'Filter',
  render: () => <div style={{
    display: 'flex',
...
}`,...(W=(N=y.parameters)==null?void 0:N.docs)==null?void 0:W.source}}};var R,G,q;x.parameters={...x.parameters,docs:{...(R=x.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: 'Sort',
  render: () => <div style={{
    display: 'flex',
    gap: 'var(--global-spacing-sizing-8px)',
...
}`,...(Z=(H=u.parameters)==null?void 0:H.docs)==null?void 0:Z.source}}};var O,$,K;f.parameters={...f.parameters,docs:{...(O=f.parameters)==null?void 0:O.docs,source:{originalSource:`{
  name: 'Disabled',
  render: () => <div style={{
    display: 'flex',
    gap: 'var(--global-spacing-sizing-8px)',
