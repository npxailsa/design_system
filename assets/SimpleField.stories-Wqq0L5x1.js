import{r as m,j as e,R as Y}from"./vendor-react-DbhTI_a3.js";import{u as pa,k as u,h as k,aA as ga}from"./vendor-mui-icons-B9T1ySRh.js";import{T as ua}from"./Tag-CnwlJDjv.js";import{I as ma}from"./vendor-mui-core-CjcFYzit.js";import{D as l}from"./DocsTemplate-IhRQ5m1Q.js";import"../vite-inject-mocker-entry.js";import"./vendor-misc-BD0vWy5z.js";import"./vendor-emotion-DfrZ-FAO.js";const ha="_field_1r54b_8",xa="_label_1r54b_17",ba="_control_1r54b_29",fa="_leadingIcon_1r54b_118",va="_iconSvg_1r54b_140",ya="_tagScrollArea_1r54b_149",Sa="_inputRoot_1r54b_166",Ta="_nativeInput_1r54b_178",Ia="_clearBtn_1r54b_211",ja="_clearIcon_1r54b_229",wa="_dropdown_1r54b_242",za="_dropdownOption_1r54b_263",_a="_dropdownEmpty_1r54b_284",Ca="_helper_1r54b_297",o={field:ha,label:xa,control:ba,"control--extra-small":"_control--extra-small_1r54b_58","control--small":"_control--small_1r54b_64","control--default":"_control--default_1r54b_70","control--large":"_control--large_1r54b_76","control--error":"_control--error_1r54b_83","control--warning":"_control--warning_1r54b_92","control--success":"_control--success_1r54b_101","control--disabled":"_control--disabled_1r54b_110",leadingIcon:fa,"field--extra-small":"_field--extra-small_1r54b_140",iconSvg:va,"field--small":"_field--small_1r54b_141","field--default":"_field--default_1r54b_142","field--large":"_field--large_1r54b_143",tagScrollArea:ya,inputRoot:Sa,nativeInput:Ta,"field--disabled":"_field--disabled_1r54b_199",clearBtn:Ia,clearIcon:ja,dropdown:wa,"control--open":"_control--open_1r54b_259",dropdownOption:za,"dropdownOption--active":"_dropdownOption--active_1r54b_280",dropdownEmpty:_a,helper:Ca,"helper--error":"_helper--error_1r54b_305","helper--warning":"_helper--warning_1r54b_306","helper--success":"_helper--success_1r54b_307"},d=({label:a,placeholder:i,value:s="",onChange:c,size:r="default",state:n="default",helperText:g,leadingIcon:p,clearable:v=!1,onClear:h,tags:x,onTagRemove:y,tagColour:b="blue",suggestions:S,onSuggestionSelect:I,suggestionsLabel:ae="option",disabled:j=!1,type:Xe="text",id:Ye,name:ea,className:aa,ariaLabel:la})=>{const le=m.useId(),F=`${le}-listbox`,te=Ye??le,J=m.useRef(null),X=m.useRef(null),[E,z]=m.useState(!1),[_,L]=m.useState(-1),ta=new Set((x??[]).map(t=>t.label.toLowerCase())),sa=s.toLowerCase().trim(),D=S?S.filter(t=>t.toLowerCase().includes(sa)&&!ta.has(t.toLowerCase())):[],C=!!S,se=C&&E&&!j;m.useEffect(()=>{if(!E)return;const t=f=>{X.current&&!X.current.contains(f.target)&&(z(!1),L(-1))};return document.addEventListener("pointerdown",t),()=>document.removeEventListener("pointerdown",t)},[E]);const re=m.useCallback(t=>{var f;I==null||I(t),z(!1),L(-1),(f=J.current)==null||f.focus()},[I]),ra=t=>{if(C)switch(t.key){case"ArrowDown":t.preventDefault(),z(!0),L(f=>Math.min(f+1,D.length-1));break;case"ArrowUp":t.preventDefault(),L(f=>Math.max(f-1,-1));break;case"Enter":E&&_>=0&&D[_]&&(t.preventDefault(),re(D[_]));break;case"Escape":z(!1),L(-1);break;case"Backspace":!s&&x&&x.length>0&&y&&y(x[x.length-1].id);break}},ia=t=>{c==null||c(t),z(!0),L(-1)},ie=x&&x.length>0,na=v&&!j&&s&&s.length>0,oa=[o.field,o[`field--${r}`],o[`field--${n}`],j&&o["field--disabled"],aa].filter(Boolean).join(" "),da=[o.control,o[`control--${r}`],o[`control--${n}`],j&&o["control--disabled"],se&&o["control--open"]].filter(Boolean).join(" ");return e.jsxs("div",{ref:X,className:oa,children:[a&&e.jsx("label",{htmlFor:te,className:o.label,children:a}),e.jsxs("div",{className:da,onClick:()=>{var t;j||(t=J.current)==null||t.focus()},children:[p&&e.jsx("span",{className:o.leadingIcon,"aria-hidden":"true",children:e.jsx(p,{className:o.iconSvg})}),e.jsxs("div",{className:o.tagScrollArea,children:[ie&&x.map(t=>e.jsx(ua,{label:t.label,size:r,colour:b,variant:"filled",showRemove:!!y&&!j,onRemove:y?()=>y(t.id):void 0,disabled:j},t.id)),e.jsx(ma,{id:te,inputRef:J,value:s,onChange:ia,onFocus:()=>{C&&s.length>0&&z(!0)},onKeyDown:ra,placeholder:ie?void 0:i,disabled:j,type:Xe,name:ea,inputProps:{"aria-label":la,"aria-autocomplete":C?"list":void 0,"aria-expanded":C?E:void 0,"aria-controls":C?F:void 0,"aria-activedescendant":_>=0?`${F}-opt-${_}`:void 0,role:C?"combobox":void 0,className:o.nativeInput},classes:{root:o.inputRoot,input:o.nativeInput}})]}),na&&e.jsx("button",{type:"button",className:o.clearBtn,onClick:t=>{t.stopPropagation(),h==null||h(),z(!1)},"aria-label":"Clear input",tabIndex:-1,children:e.jsx(pa,{className:o.clearIcon})})]}),se&&e.jsx("ul",{id:F,role:"listbox","aria-label":`${ae} suggestions`,className:o.dropdown,children:D.length>0?D.map((t,f)=>e.jsx("li",{id:`${F}-opt-${f}`,role:"option","aria-selected":f===_,className:[o.dropdownOption,f===_&&o["dropdownOption--active"]].filter(Boolean).join(" "),onPointerDown:ca=>{ca.preventDefault(),re(t)},children:t},t)):e.jsxs("li",{className:o.dropdownEmpty,"aria-disabled":"true",children:["No matching ",ae]})}),g&&e.jsx("span",{className:[o.helper,n!=="default"&&o[`helper--${n}`]].filter(Boolean).join(" "),role:n==="error"?"alert":void 0,children:g})]})};d.__docgenInfo={description:`SimpleField — a single-line text input built on MUI's \`InputBase\`.
...
}`,...(de=(oe=O.parameters)==null?void 0:oe.docs)==null?void 0:de.source}}};var ce,pe,ge;R.parameters={...R.parameters,docs:{...(ce=R.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  name: 'Playground',
...
}`,...(ke=(Le=H.parameters)==null?void 0:Le.docs)==null?void 0:ke.source}}};var Ee,De,Ae;U.parameters={...U.parameters,docs:{...(Ee=U.parameters)==null?void 0:Ee.docs,source:{originalSource:`{
...
}`,...(Ae=(De=U.parameters)==null?void 0:De.docs)==null?void 0:Ae.source}}};var Fe,We,Oe;M.parameters={...M.parameters,docs:{...(Fe=M.parameters)==null?void 0:Fe.docs,source:{originalSource:`{
...
}`,...(Oe=(We=M.parameters)==null?void 0:We.docs)==null?void 0:Oe.source}}};var Re,Pe,Be;Q.parameters={...Q.parameters,docs:{...(Re=Q.parameters)==null?void 0:Re.docs,source:{originalSource:`{
...
}`,...(qe=(Ge=$.parameters)==null?void 0:Ge.docs)==null?void 0:qe.source}}};var He,Ue,Me;V.parameters={...V.parameters,docs:{...(He=V.parameters)==null?void 0:He.docs,source:{originalSource:`{
...
}`,...(Me=(Ue=V.parameters)==null?void 0:Ue.docs)==null?void 0:Me.source}}};var Qe,$e,Ve;Z.parameters={...Z.parameters,docs:{...(Qe=Z.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
...
}`,...(Ve=($e=Z.parameters)==null?void 0:$e.docs)==null?void 0:Ve.source}}};const Na=["Documentation","Playground","Default","Sizes","StatusError","StatusWarning","StatusSuccess","StatusDisabled","StatusTagInput","TagInput","TagInputSizes","ComponentBreakdown","AllInteractiveStates","FullDesignMatrix"];export{V as AllInteractiveStates,$ as ComponentBreakdown,P as Default,O as Documentation,Z as FullDesignMatrix,R as Playground,B as Sizes,H as StatusDisabled,N as StatusError,q as StatusSuccess,U as StatusTagInput,G as StatusWarning,M as TagInput,Q as TagInputSizes,Na as __namedExportsOrder,Ba as default};
