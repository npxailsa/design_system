import{j as e,R as d}from"./iframe-CJnzxUdm.js";import{D as a}from"./DocsTemplate-UgWcV-XY.js";import"./preload-helper-Dp1pzeXC.js";const he="_divider_1f5ln_20",p={divider:he,"divider--horizontal":"_divider--horizontal_1f5ln_35","divider--vertical":"_divider--vertical_1f5ln_52","divider--solid":"_divider--solid_1f5ln_69","divider--dashed":"_divider--dashed_1f5ln_70","divider--dotted":"_divider--dotted_1f5ln_71","divider--0-5px":"_divider--0-5px_1f5ln_85","divider--1px":"_divider--1px_1f5ln_86","divider--2px":"_divider--2px_1f5ln_87","divider--3px":"_divider--3px_1f5ln_88","divider--4px":"_divider--4px_1f5ln_89","divider--8px":"_divider--8px_1f5ln_90"},l=({line:i="solid",thickness:n="1px",alignment:c="horizontal",className:xe="",ariaLabel:ve="Divider"})=>{const ye=[p.divider,p[`divider--${c}`],p[`divider--${i}`],p[`divider--${n}`],xe].filter(Boolean).join(" ");return e.jsx("div",{role:"separator","aria-label":ve,"aria-orientation":c,className:ye})};l.__docgenInfo={description:"",methods:[],displayName:"Divider",props:{line:{required:!1,tsType:{name:"union",raw:"'solid' | 'dashed' | 'dotted'",elements:[{name:"literal",value:"'solid'"},{name:"literal",value:"'dashed'"},{name:"literal",value:"'dotted'"}]},description:`Line style for the divider.
