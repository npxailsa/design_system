import{j as e}from"./iframe-DPKTwdjf.js";import{P as We}from"./Person-DPiJypGd.js";import{S as Ee}from"./StatusIndicator-DWozB_jX.js";import{D as r}from"./DocsTemplate-Bb0qJ9XD.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-Dn4_sAvp.js";const Le="_avatar_grb5z_7",Be="_imageWrap_grb5z_110",Me="_photo_grb5z_123",Fe="_personIcon_grb5z_131",Ne="_initials_grb5z_144",Ce="_badge_grb5z_165",n={avatar:Le,"size-x-small":"_size-x-small_grb5z_34","size-small":"_size-small_grb5z_39","size-default":"_size-default_grb5z_44","size-large":"_size-large_grb5z_49","shape-circle":"_shape-circle_grb5z_59","shape-square":"_shape-square_grb5z_64","type-empty-state":"_type-empty-state_grb5z_72","type-profile-photo":"_type-profile-photo_grb5z_76","type-initial-light":"_type-initial-light_grb5z_80","type-initial-dark":"_type-initial-dark_grb5z_84","border-false":"_border-false_grb5z_93","border-true":"_border-true_grb5z_100",imageWrap:Be,photo:Me,personIcon:Fe,initials:Ne,badge:Ce},He={"x-small":"small",small:"large",default:"default",large:"default"},s=({type:a="empty-state",size:t="default",shape:i="square",border:T=!1,statusIcon:we=!1,initials:Te="A",src:q,alt:O="User avatar",className:De=""})=>{const Pe=[n.avatar,n[`size-${t}`],n[`type-${a}`],n[`shape-${i}`],T?n["border-true"]:n["border-false"],De].filter(Boolean).join(" "),qe=a==="profile-photo"||a==="empty-state",Oe=a==="initial-light"||a==="initial-dark";return e.jsxs("div",{className:Pe,"aria-label":O,role:"img",children:[qe&&e.jsx("div",{className:n.imageWrap,children:a==="profile-photo"&&q?e.jsx("img",{className:n.photo,src:q,alt:O}):e.jsx(We,{className:n.personIcon,"aria-hidden":"true"})}),Oe&&e.jsx("span",{className:n.initials,"aria-hidden":"true",children:Te}),we&&e.jsx(Ee,{status:"do-not-disturb",size:He[t],className:n.badge,ariaLabel:"Do not disturb"})]})};s.__docgenInfo={description:`Avatar — Displays a user identity in one of four modes:
...
}`,...(F=(M=g.parameters)==null?void 0:M.docs)==null?void 0:F.source}}};var N,C,H;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: 'Empty State',
  args: {
    type: 'empty-state',
    size: 'default',
...
}`,...(H=(C=u.parameters)==null?void 0:C.docs)==null?void 0:H.source}}};var V,$,Z;m.parameters={...m.parameters,docs:{...(V=m.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(Z=($=m.parameters)==null?void 0:$.docs)==null?void 0:Z.source}}};var U,R,Y;h.parameters={...h.parameters,docs:{...(U=h.parameters)==null?void 0:U.docs,source:{originalSource:`{
...
}`,...(ee=(Q=f.parameters)==null?void 0:Q.docs)==null?void 0:ee.source}}};var ae,re,te;x.parameters={...x.parameters,docs:{...(ae=x.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  name: 'Initial — Dark',
  args: {
    type: 'initial-dark',
    size: 'default',
...
}`,...(te=(re=x.parameters)==null?void 0:re.docs)==null?void 0:te.source}}};var ie,se,oe;v.parameters={...v.parameters,docs:{...(ie=v.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
    type: 'profile-photo',
    size: 'default',
    shape: 'square',
...
}`,...(pe=(ne=b.parameters)==null?void 0:ne.docs)==null?void 0:pe.source}}};var de,ce,ge;z.parameters={...z.parameters,docs:{...(de=z.parameters)==null?void 0:de.docs,source:{originalSource:`{
  name: 'With Border',
  args: {
    type: 'profile-photo',
    size: 'default',
...
}`,...(ge=(ce=z.parameters)==null?void 0:ce.docs)==null?void 0:ge.source}}};var ue,me,he;S.parameters={...S.parameters,docs:{...(ue=S.parameters)==null?void 0:ue.docs,source:{originalSource:`{
...
}`,...(he=(me=S.parameters)==null?void 0:me.docs)==null?void 0:he.source}}};var ye,fe,xe;j.parameters={...j.parameters,docs:{...(ye=j.parameters)==null?void 0:ye.docs,source:{originalSource:`{
  name: 'All Sizes',
  render: () => <div style={{
    display: 'flex',
    alignItems: 'flex-end',
