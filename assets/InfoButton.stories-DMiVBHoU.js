...
--btn-border-radius`,description:"Outer shell. Fill: color/status/info-blue (#366F97). Border: 1px solid same color. Hover adds 2×2px info-blue drop shadow. Focus uses 2px border. Radius: 4px."},{id:2,name:"Leading Icon",token:`--btn-info-solid-color
...
}`,...(I=(y=l.parameters)==null?void 0:y.docs)==null?void 0:I.source},description:{story:"Full documentation — design specs, token table, anatomy and usage examples.",...(w=(j=l.parameters)==null?void 0:j.docs)==null?void 0:w.description}}};var z,B,C,F,k;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    label: 'Info button',
    variant: 'solid',
    size: 'default',
...
}`,...(C=(B=r.parameters)==null?void 0:B.docs)==null?void 0:C.source},description:{story:"Interactive playground — adjust all props via the Controls panel.",...(k=(F=r.parameters)==null?void 0:F.docs)==null?void 0:k.description}}};var S,_,L,T,D;d.parameters={...d.parameters,docs:{...(S=d.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    label: 'Info button',
    variant: 'solid',
    size: 'default'
...
}`,...(E=(N=b.parameters)==null?void 0:N.docs)==null?void 0:E.source},description:{story:"Both variants side by side — as they appear in an info CardContent ButtonGroup.",...(G=(P=b.parameters)==null?void 0:P.docs)==null?void 0:G.description}}};var O,U,q,Z,X;p.parameters={...p.parameters,docs:{...(O=p.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(q=(U=p.parameters)==null?void 0:U.docs)==null?void 0:q.source},description:{story:"All three sizes — small (34px), default (44px), large (56px).",...(X=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:X.description}}};var Y,$,J,K,Q;u.parameters={...u.parameters,docs:{...(Y=u.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(J=($=u.parameters)==null?void 0:$.docs)==null?void 0:J.source},description:{story:"Loading state — spinner replaces the leading icon, trailing icon hidden.",...(Q=(K=u.parameters)==null?void 0:K.docs)==null?void 0:Q.description}}};var ee,te,ae,ne,oe;g.parameters={...g.parameters,docs:{...(ee=g.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(ae=(te=g.parameters)==null?void 0:te.docs)==null?void 0:ae.source},description:{story:"Disabled state — grey background, grey text, not interactive.",...(oe=(ne=g.parameters)==null?void 0:ne.docs)==null?void 0:oe.description}}};var ie,se,le,re,de;f.parameters={...f.parameters,docs:{...(ie=f.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '32px',
...
}`,...(le=(se=f.parameters)==null?void 0:se.docs)==null?void 0:le.source},description:{story:"Full state matrix — all combinations of variant × size × state.",...(de=(re=f.parameters)==null?void 0:re.docs)==null?void 0:de.description}}};const Se=["Documentation","Playground","Solid","Ghost","BothVariants","Sizes","Loading","Disabled","AllStates"];export{f as AllStates,b as BothVariants,g as Disabled,l as Documentation,c as Ghost,u as Loading,r as Playground,p as Sizes,d as Solid,Se as __namedExportsOrder,ke as default};
