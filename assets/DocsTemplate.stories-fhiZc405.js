...
/>`}),e.jsx(o.TokenTable,{title:"Design Tokens Used",description:"The template relies on existing design system tokens. Key tokens include:",tokens:[{name:"--font-family-primary",description:"Typography — F37 Ginger Pro"},{name:"--font-family-secondary",description:"Typography — Calibri"},{name:"--global-color-base-black",description:"Colour — base black text"},{name:"--color-primary-blue-blue",description:"Colour — primary brand blue"},{name:"--color-primary-blue-blue-50",description:"Background — principle cards, token tables"},{name:"--color-additional-gray-light-light-gray-default",description:"Background — code blocks"},{name:"--global-spacing-sizing-*",description:"Spacing — all spacing scale values"},{name:"--global-spacing-radius-12px",description:"Spacing — card border radius"}]}),e.jsx(o.Section,{title:"Reference implementation",children:e.jsxs(o.BodyText,{children:["See the ",e.jsx("strong",{children:"Iconography"})," story under"," ",e.jsx("strong",{children:"Foundation/DocsTemplate"})," for a complete example of all sub-components working together to produce a full documentation page."]})}),e.jsx(o.Footer,{})]});be.__docgenInfo={description:"",methods:[],displayName:"DocsTemplateDocs"};const Xe={title:"Foundation/DocsTemplate",component:o,parameters:{layout:"fullscreen"}},t={render:()=>e.jsx(be,{}),parameters:{controls:{disable:!0},actions:{disable:!0}}},s={render:()=>e.jsx(ye,{})},a={render:()=>e.jsxs(o,{children:[e.jsx(o.Header,{title:"Component Name",subtitle:"A short description of the component and its purpose"}),e.jsx(o.BodyText,{children:"This is body text that provides additional context about the component. It uses the secondary font family (Calibri) at the large body size."}),e.jsx(o.Section,{title:"Section Title",subtitle:"Optional subtitle that provides additional context.",children:e.jsx(o.BodyText,{children:"Content within a section is indented and spaced consistently."})}),e.jsx(o.Footer,{})]})},r={render:()=>e.jsx(o,{children:e.jsx(o.TokenTable,{title:"Design Tokens",description:"We use the following tokens to style this component:",tokens:[{name:"--brand-primary",description:"Primary brand colour"},{name:"--brand-secondary",description:"Secondary brand colour"},{name:"--global-spacing-sizing-8px",description:"Base spacing unit"}]})})},c={render:()=>e.jsx(o,{children:e.jsxs(o.Principles,{children:[e.jsx(o.PrincipleCard,{number:1,title:"Consistency",children:"Maintain visual and behavioural consistency across all components."}),e.jsx(o.PrincipleCard,{number:2,title:"Accessibility",children:"Ensure every component is usable by people of all abilities."})]})})},l={render:()=>e.jsx(o,{children:e.jsx(o.CodeBlock,{children:`import { Button } from './components/Button';

const App = () => (
  <Button variant="primary" size="default">
    Click me
  </Button>
);`})})},d={render:()=>e.jsx(o,{children:e.jsx(o.DosDonts,{doItem:{icon:e.jsx(n,{icon:u,size:"x-large"}),label:"Settings",description:"Use familiar symbols with clear associations."},dontItem:{icon:e.jsx(n,{icon:ue,size:"x-large"}),label:"Settings",description:"Don’t use unfamiliar symbols that could be confused."}})})},p={render:()=>e.jsx(o,{children:e.jsx(o.IconGallery,{items:[{icon:e.jsx(n,{icon:i,size:"x-large"}),label:"Home"},{icon:e.jsx(n,{icon:xe,size:"x-large"}),label:"Search"},{icon:e.jsx(n,{icon:u,size:"x-large"}),label:"Settings"},{icon:e.jsx(n,{icon:ge,size:"x-large"}),label:"Favorite"}]})})},m={render:()=>e.jsxs(o,{children:[e.jsx(o.Section,{title:"Component Anatomy",children:e.jsxs(o.BodyText,{children:["Use ",e.jsx("strong",{children:"DocsTemplate.Anatomy"})," to create annotated diagrams that map numbered pins on a live component preview to their design tokens and descriptions."]})}),e.jsx(o.Anatomy,{preview:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px",padding:"12px 16px",border:"1px solid #ccc",borderRadius:"8px",fontFamily:"var(--font-family-primary)",fontSize:"14px",background:"white",width:"100%",maxWidth:"420px"},children:[e.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",style:{opacity:.5,flexShrink:0},children:[e.jsx("circle",{cx:"11",cy:"11",r:"9",stroke:"#3A3282",strokeWidth:"2"}),e.jsx("circle",{cx:"11",cy:"11",r:"5",stroke:"#3A3282",strokeWidth:"2"}),e.jsx("circle",{cx:"11",cy:"11",r:"1.5",fill:"#3A3282"})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"2px",flex:1},children:[e.jsx("span",{style:{color:"#3A3282",fontWeight:400},children:"This is a sample component"}),e.jsx("span",{style:{color:"#374151",fontWeight:300,fontSize:"13px"},children:"Supporting description text"})]}),e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",style:{opacity:.5,flexShrink:0},children:e.jsx("path",{d:"M12.67 4.27L11.73 3.33L8 7.06L4.27 3.33L3.33 4.27L7.06 8L3.33 11.73L4.27 12.67L8 8.94L11.73 12.67L12.67 11.73L8.94 8L12.67 4.27Z",fill:"#3A3282"})})]}),parts:[{id:1,name:"Leading Icon",token:`filled/icons (display)
--component-leading-icon-size
--component-icon-opacity`,description:"Context-sensitive icon indicating the component type or state. Rendered at 50% opacity.",pin:{top:"50%",left:"5%"}},{id:2,name:"Title",token:`--component-font-family
--component-title-size
--component-title-color`,description:"Primary text using F37 Ginger Pro Regular. Colour changes per variant.",pin:{top:"30%",left:"50%"}},{id:3,name:"Description",token:`--component-font-family
--component-desc-size
--component-desc-color`,description:"Supporting subtext at 300 weight. Always gray-700.",pin:{top:"70%",left:"50%"}},{id:4,name:"Close Icon",token:`filled/icons (action)
--component-close-icon-size
--component-icon-opacity`,description:"Optional dismiss action with 50% opacity. Toggle with showTrailingIcon prop.",pin:{top:"50%",left:"95%"}}]})]})},h={render:()=>e.jsx(o,{children:e.jsx(o.SizeDemo,{rows:[{label:"Default (16px)",sublabel:"use in most cases",children:e.jsx(n,{icon:i,size:"default"})},{label:"Small (14px)",sublabel:"Use sparingly",children:e.jsx(n,{icon:i,size:"small"})},{label:"Large (18px)",sublabel:"Use sparingly",children:e.jsx(n,{icon:i,size:"large"})}]})})};var b,f,T,j,D;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`{
...
}`,...(T=(f=t.parameters)==null?void 0:f.docs)==null?void 0:T.source},description:{story:"Full branded documentation page for the DocsTemplate system.",...(D=(j=t.parameters)==null?void 0:j.docs)==null?void 0:D.description}}};var I,w,S,k,v;s.parameters={...s.parameters,docs:{...(I=s.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
implementation of the DocsTemplate system.`,...(v=(k=s.parameters)==null?void 0:k.docs)==null?void 0:v.description}}};var z,C,B,A,P;a.parameters={...a.parameters,docs:{...(z=a.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(B=(C=a.parameters)==null?void 0:C.docs)==null?void 0:B.source},description:{story:"Shows the basic page structure: Header, Section, BodyText, and Footer.",...(P=(A=a.parameters)==null?void 0:A.docs)==null?void 0:P.description}}};var L,O,F,U,E;r.parameters={...r.parameters,docs:{...(L=r.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(F=(O=r.parameters)==null?void 0:O.docs)==null?void 0:F.source},description:{story:`Demonstrates the TokenTable sub-component used to display design token
name/description pairs inside a styled blue card.`,...(E=(U=r.parameters)==null?void 0:U.docs)==null?void 0:E.description}}};var M,H,W,G,N;c.parameters={...c.parameters,docs:{...(M=c.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
Do and Don't comparison cards.`,...(Q=(J=d.parameters)==null?void 0:J.docs)==null?void 0:Q.description}}};var $,ee,oe,ne,ie;p.parameters={...p.parameters,docs:{...($=p.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
of icons with labels.`,...(ie=(ne=p.parameters)==null?void 0:ne.docs)==null?void 0:ie.description}}};var te,se,ae,re,ce;m.parameters={...m.parameters,docs:{...(te=m.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(pe=(de=h.parameters)==null?void 0:de.docs)==null?void 0:pe.source},description:{story:"Demonstrates the SizeDemo sub-component for showing icon sizes.",...(he=(me=h.parameters)==null?void 0:me.docs)==null?void 0:he.description}}};const Ve=["UsageGuide","Iconography","BasicPageStructure","TokenTableExample","PrincipleCardsExample","CodeBlockExample","DosDontsExample","IconGalleryExample","ComponentAnatomyExample","SizeDemoExample"];export{a as BasicPageStructure,l as CodeBlockExample,m as ComponentAnatomyExample,d as DosDontsExample,p as IconGalleryExample,s as Iconography,c as PrincipleCardsExample,h as SizeDemoExample,r as TokenTableExample,t as UsageGuide,Ve as __namedExportsOrder,Xe as default};
