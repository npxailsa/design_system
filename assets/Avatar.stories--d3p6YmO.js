import{j as e}from"./iframe-ed3UfVX2.js";import{P as We}from"./Person-amsY0Uv1.js";import{S as Ee}from"./StatusIndicator-BaRChaFD.js";import{D as t}from"./DocsTemplate-GIGdF2Zd.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-B-TwLYzZ.js";const Le="_avatar_2omei_7",Be="_imageWrap_2omei_110",Me="_photo_2omei_123",Fe="_personIcon_2omei_131",Ne="_initials_2omei_144",Ce="_badge_2omei_165",n={avatar:Le,"size-x-small":"_size-x-small_2omei_34","size-small":"_size-small_2omei_39","size-default":"_size-default_2omei_44","size-large":"_size-large_2omei_49","shape-circle":"_shape-circle_2omei_59","shape-square":"_shape-square_2omei_64","type-empty-state":"_type-empty-state_2omei_72","type-profile-photo":"_type-profile-photo_2omei_76","type-initial-light":"_type-initial-light_2omei_80","type-initial-dark":"_type-initial-dark_2omei_84","border-false":"_border-false_2omei_93","border-true":"_border-true_2omei_100",imageWrap:Be,photo:Me,personIcon:Fe,initials:Ne,badge:Ce},He={"x-small":"small",small:"large",default:"default",large:"default"},s=({type:a="empty-state",size:r="default",shape:i="square",border:T=!1,statusIcon:we=!1,initials:Te="A",src:q,alt:O="User avatar",className:De=""})=>{const Pe=[n.avatar,n[`size-${r}`],n[`type-${a}`],n[`shape-${i}`],T?n["border-true"]:n["border-false"],De].filter(Boolean).join(" "),qe=a==="profile-photo"||a==="empty-state",Oe=a==="initial-light"||a==="initial-dark";return e.jsxs("div",{className:Pe,"aria-label":O,role:"img",children:[qe&&e.jsx("div",{className:n.imageWrap,children:a==="profile-photo"&&q?e.jsx("img",{className:n.photo,src:q,alt:O}):e.jsx(We,{className:n.personIcon,"aria-hidden":"true"})}),Oe&&e.jsx("span",{className:n.initials,"aria-hidden":"true",children:Te}),we&&e.jsx(Ee,{status:"do-not-disturb",size:He[r],className:n.badge,ariaLabel:"Do not disturb"})]})};s.__docgenInfo={description:`Avatar — Displays a user identity in one of four modes:
...
}`,...(F=(M=m.parameters)==null?void 0:M.docs)==null?void 0:F.source}}};var N,C,H;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: 'Empty State',
  args: {
    type: 'empty-state',
    size: 'default',
...
}`,...(H=(C=u.parameters)==null?void 0:C.docs)==null?void 0:H.source}}};var V,$,Z;g.parameters={...g.parameters,docs:{...(V=g.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(pe=(ne=b.parameters)==null?void 0:ne.docs)==null?void 0:pe.source}}};var de,ce,me;z.parameters={...z.parameters,docs:{...(de=z.parameters)==null?void 0:de.docs,source:{originalSource:`{
  name: 'With Border',
  args: {
    type: 'profile-photo',
    size: 'default',
...
}`,...(me=(ce=z.parameters)==null?void 0:ce.docs)==null?void 0:me.source}}};var ue,ge,he;S.parameters={...S.parameters,docs:{...(ue=S.parameters)==null?void 0:ue.docs,source:{originalSource:`{
