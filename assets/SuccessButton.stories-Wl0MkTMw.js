...
}`,...(E=(R=u.parameters)==null?void 0:R.docs)==null?void 0:E.source},description:{story:"Both variants side by side — as they appear in a success CardContent ButtonGroup.",...(P=(N=u.parameters)==null?void 0:N.docs)==null?void 0:P.description}}};var G,O,U,Z,X;p.parameters={...p.parameters,docs:{...(G=p.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(J=($=b.parameters)==null?void 0:$.docs)==null?void 0:J.source},description:{story:"Loading state — spinner replaces the leading icon, trailing icon hidden.",...(Q=(K=b.parameters)==null?void 0:K.docs)==null?void 0:Q.description}}};var ee,se,te,ae,ne;g.parameters={...g.parameters,docs:{...(ee=g.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    gap: '12px',
    alignItems: 'center',
...
}`,...(te=(se=g.parameters)==null?void 0:se.docs)==null?void 0:te.source},description:{story:"Disabled state — grey background, grey text, not interactive.",...(ne=(ae=g.parameters)==null?void 0:ae.docs)==null?void 0:ne.description}}};var ie,re,oe,le,ce;h.parameters={...h.parameters,docs:{...(ie=h.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '32px',
...
Hover over the solid buttons to see the unique dark-green colour inversion.`,...(ce=(le=h.parameters)==null?void 0:le.docs)==null?void 0:ce.description}}};const _e=["Documentation","Playground","Solid","Ghost","BothVariants","Sizes","Loading","Disabled","AllStates"];export{h as AllStates,u as BothVariants,g as Disabled,o as Documentation,d as Ghost,b as Loading,l as Playground,p as Sizes,c as Solid,_e as __namedExportsOrder,Fe as default};
