...
}`,...(j=(D=i.parameters)==null?void 0:D.docs)==null?void 0:j.source},description:{story:"Documentation — must be listed first per design system convention.",...(w=(I=i.parameters)==null?void 0:I.docs)==null?void 0:w.description}}};var S,k,z,v,C;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => <DocsTemplateDocs />,
  parameters: {
    controls: {
      disable: true
...
}`,...(z=(k=s.parameters)==null?void 0:k.docs)==null?void 0:z.source},description:{story:"Full branded documentation page for the DocsTemplate system.",...(C=(v=s.parameters)==null?void 0:v.docs)==null?void 0:C.description}}};var B,P,F,A,O;a.parameters={...a.parameters,docs:{...(B=a.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => <IconographyDocs />
}`,...(F=(P=a.parameters)==null?void 0:P.docs)==null?void 0:F.source},description:{story:`The full Iconography documentation page — a complete reference
implementation of the DocsTemplate system.`,...(O=(A=a.parameters)==null?void 0:A.docs)==null?void 0:O.description}}};var U,E,G,H,M;r.parameters={...r.parameters,docs:{...(U=r.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(G=(E=r.parameters)==null?void 0:E.docs)==null?void 0:G.source},description:{story:"Shows the basic page structure: Header, Section, BodyText, and Footer.",...(M=(H=r.parameters)==null?void 0:H.docs)==null?void 0:M.description}}};var L,N,R,W,V;c.parameters={...c.parameters,docs:{...(L=c.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(R=(N=c.parameters)==null?void 0:N.docs)==null?void 0:R.source},description:{story:`Demonstrates the TokenTable sub-component used to display design token
name/description pairs inside a styled blue card.`,...(V=(W=c.parameters)==null?void 0:W.docs)==null?void 0:V.description}}};var q,_,X,K,Y;l.parameters={...l.parameters,docs:{...(q=l.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(X=(_=l.parameters)==null?void 0:_.docs)==null?void 0:X.source},description:{story:"Demonstrates PrincipleCards inside the Principles container.",...(Y=(K=l.parameters)==null?void 0:K.docs)==null?void 0:Y.description}}};var J,Q,Z,$,ee;d.parameters={...d.parameters,docs:{...(J=d.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(Z=(Q=d.parameters)==null?void 0:Q.docs)==null?void 0:Z.source},description:{story:"Demonstrates the CodeBlock sub-component for displaying code snippets.",...(ee=($=d.parameters)==null?void 0:$.docs)==null?void 0:ee.description}}};var oe,ne,te,ie,se;p.parameters={...p.parameters,docs:{...(oe=p.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(te=(ne=p.parameters)==null?void 0:ne.docs)==null?void 0:te.source},description:{story:`Demonstrates the DosDonts sub-component with side-by-side
Do and Don't comparison cards.`,...(se=(ie=p.parameters)==null?void 0:ie.docs)==null?void 0:se.description}}};var ae,re,ce,le,de;m.parameters={...m.parameters,docs:{...(ae=m.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(ce=(re=m.parameters)==null?void 0:re.docs)==null?void 0:ce.source},description:{story:`Demonstrates the IconGallery sub-component for displaying a grid
of icons with labels.`,...(de=(le=m.parameters)==null?void 0:le.docs)==null?void 0:de.description}}};var pe,me,ue,he,ge;u.parameters={...u.parameters,docs:{...(pe=u.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(ue=(me=u.parameters)==null?void 0:me.docs)==null?void 0:ue.source},description:{story:`Demonstrates the Anatomy sub-component for documenting
the numbered parts of a component with tokens and descriptions.`,...(ge=(he=u.parameters)==null?void 0:he.docs)==null?void 0:ge.description}}};var be,xe,ye,fe,Te;h.parameters={...h.parameters,docs:{...(be=h.parameters)==null?void 0:be.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(ye=(xe=h.parameters)==null?void 0:xe.docs)==null?void 0:ye.source},description:{story:"Demonstrates the SizeDemo sub-component for showing icon sizes.",...(Te=(fe=h.parameters)==null?void 0:fe.docs)==null?void 0:Te.description}}};const no=["Documentation","UsageGuide","Iconography","BasicPageStructure","TokenTableExample","PrincipleCardsExample","CodeBlockExample","DosDontsExample","IconGalleryExample","ComponentAnatomyExample","SizeDemoExample"];export{r as BasicPageStructure,d as CodeBlockExample,u as ComponentAnatomyExample,i as Documentation,p as DosDontsExample,m as IconGalleryExample,a as Iconography,l as PrincipleCardsExample,h as SizeDemoExample,c as TokenTableExample,s as UsageGuide,no as __namedExportsOrder,oo as default};
