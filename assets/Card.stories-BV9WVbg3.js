import{j as e}from"./iframe-nQGqS2k4.js";import{D as r}from"./DocsTemplate-DYzNhLD1.js";import"./preload-helper-Dp1pzeXC.js";const te="_card_1rtjp_6",s={card:te,"size-small":"_size-small_1rtjp_40","size-default":"_size-default_1rtjp_47","size-large":"_size-large_1rtjp_54","shadow-true":"_shadow-true_1rtjp_64","shadow-false":"_shadow-false_1rtjp_69","bg-default":"_bg-default_1rtjp_80","mode-light":"_mode-light_1rtjp_80","mode-dark":"_mode-dark_1rtjp_84","bg-sky-blue":"_bg-sky-blue_1rtjp_90","bg-blue":"_bg-blue_1rtjp_100","bg-error":"_bg-error_1rtjp_106","bg-success":"_bg-success_1rtjp_116","bg-warning":"_bg-warning_1rtjp_127","bg-info-blue":"_bg-info-blue_1rtjp_133","bg-note-purple":"_bg-note-purple_1rtjp_139","bg-light-gray":"_bg-light-gray_1rtjp_145","bg-black":"_bg-black_1rtjp_151","bg-dark-gray":"_bg-dark-gray_1rtjp_157"},o=({size:a="small",bg:l="default",mode:re="light",dropShadow:oe=!0,children:le,className:se=""})=>{const de=[s.card,s[`size-${a}`],s[`bg-${l}`],s[`mode-${re}`],oe?s["shadow-true"]:s["shadow-false"],se].filter(Boolean).join(" ");return e.jsx("div",{className:de,children:le})};o.__docgenInfo={description:`Card — Foundational surface building block with multiple colour themes,
...
}`,...(ee=(Y=b.parameters)==null?void 0:Y.docs)==null?void 0:ee.source}}};const me=["Documentation","Playground","Small","Default","Large","WithShadow","FlatNoBorder","AllColoursLightShadow","AllColoursLightFlat","DarkModeVariants","AllSizesAllColours"];export{m as AllColoursLightFlat,u as AllColoursLightShadow,b as AllSizesAllColours,h as DarkModeVariants,n as Default,d as Documentation,g as FlatNoBorder,c as Large,t as Playground,i as Small,p as WithShadow,me as __namedExportsOrder,ue as default};
