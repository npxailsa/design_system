...
/>`}),e.jsxs(a.Principles,{children:[e.jsxs(a.PrincipleCard,{number:1,title:"Drive status from your save logic",children:["Map your application's save lifecycle (idle → saving → saved / error) directly to the"," ",e.jsx("code",{children:"status"})," prop. Never manually set colours or labels — let the token system handle visual consistency."]}),e.jsx(a.PrincipleCard,{number:2,title:"Persist the button across all states",children:"Keep the button visible in all states, including saved and error. Hiding it removes important feedback for the user about their document's save status."}),e.jsx(a.PrincipleCard,{number:3,title:"Only one SaveDraftButton per form",children:"Use a single SaveDraftButton per document or form scope. Multiple buttons suggest multiple save targets, which is confusing. If you need section-level saves, use text links instead."})]}),e.jsx(a.Footer,{})]});g.__docgenInfo={description:"",methods:[],displayName:"SaveDraftButtonDocs"};const q=["default","auto-saving","saving","saved","error","disabled","focused"],ee={title:"Atoms/Save Draft Button",component:s,parameters:{docs:{page:()=>e.jsx(g,{})}},argTypes:{status:{control:"select",options:q,description:"Drives the label, background, border, and text colour of the button"},label:{control:"text",description:"Overrides the auto-derived label for the current status"}},args:{status:"default"}},n={render:()=>e.jsx(g,{}),parameters:{controls:{disable:!0},actions:{disable:!0}}},o={args:{status:"default"}},i={name:"Auto-saving",args:{status:"auto-saving"}},l={args:{status:"saving"}},d={args:{status:"saved"}},c={args:{status:"error"}},u={args:{status:"disabled"}},b={name:"All States",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-16px)",padding:"var(--global-spacing-sizing-24px)",alignItems:"flex-start"},children:q.map(t=>e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--global-spacing-sizing-20px)"},children:[e.jsx(s,{status:t}),e.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-xs)",color:"var(--global-color-neutral-gray-500)",textTransform:"capitalize"},children:t})]},t))}),parameters:{controls:{disable:!0}}};var x,h,y;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
...
}`,...(w=(D=i.parameters)==null?void 0:D.docs)==null?void 0:w.source}}};var B,A,T;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    status: 'saving'
  }
}`,...(T=(A=l.parameters)==null?void 0:A.docs)==null?void 0:T.source}}};var z,F,E;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    status: 'saved'
  }
}`,...(E=(F=d.parameters)==null?void 0:F.docs)==null?void 0:E.source}}};var C,L,I;c.parameters={...c.parameters,docs:{...(C=c.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    status: 'error'
  }
}`,...(I=(L=c.parameters)==null?void 0:L.docs)==null?void 0:I.source}}};var U,P,M;u.parameters={...u.parameters,docs:{...(U=u.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    status: 'disabled'
  }
}`,...(M=(P=u.parameters)==null?void 0:P.docs)==null?void 0:M.source}}};var N,H,R;b.parameters={...b.parameters,docs:{...(N=b.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: 'All States',
  render: () => <div style={{
    display: 'flex',
...
}`,...(R=(H=b.parameters)==null?void 0:H.docs)==null?void 0:R.source}}};const ae=["Documentation","Default","AutoSaving","Saving","Saved","Error","Disabled","AllStates"];export{b as AllStates,i as AutoSaving,o as Default,u as Disabled,n as Documentation,c as Error,d as Saved,l as Saving,ae as __namedExportsOrder,ee as default};
