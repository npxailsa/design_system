...
}`,...(De=(Ce=S.parameters)==null?void 0:Ce.docs)==null?void 0:De.source},description:{story:"Full design matrix — all sizes × all states, matching the Figma design spec.",...(Ae=(Pe=S.parameters)==null?void 0:Pe.docs)==null?void 0:Ae.description}}};const ja=["Documentation","Playground","Default","Sizes","Filled","Error","Warning","Success","Disabled","FullDesignMatrix"];export{y as Default,_ as Disabled,f as Documentation,z as Error,j as Filled,S as FullDesignMatrix,v as Playground,T as Sizes,I as Success,w as Warning,ja as __namedExportsOrder,Ta as default};
