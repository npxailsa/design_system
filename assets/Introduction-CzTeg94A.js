import{j as e}from"./iframe-DBOJ2IMB.js";import{useMDXComponents as r}from"./index-CNhyF4eP.js";import{M as o}from"./blocks-BIH_T9kU.js";import"./preload-helper-Dp1pzeXC.js";import"./index-wxQWg9Tt.js";function i(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Introduction"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Foundation"}),": Fundamental building blocks (",e.jsx(n.a,{href:"/docs/foundation-colors--docs",children:"Colors"}),", ",e.jsx(n.a,{href:"/docs/foundation-typography--docs",children:"Typography"}),", spacing)."]}),`
...
`]}),`
`,e.jsx(n.p,{children:e.jsx(n.img,{src:"https://storybook.js.org/docs-assets/10.2/writing-stories/naming-hierarchy-sidebar-anatomy.png",alt:"Sidebar Anatomy"})}),`
`,e.jsx(n.h2,{id:"getting-started",children:"Getting Started"}),`
`,e.jsx(n.h3,{id:"for-designers",children:"For Designers"}),`
...
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`npm install design-system
`})}),`
`,e.jsx(n.p,{children:"Then, wrap your application with the ThemeProvider to apply the global styles and theme:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`import { ThemeProvider } from 'design-system';
...
`,e.jsx(n.p,{children:"If you have questions or need help, please reach out to the design system team."}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Slack"}),": #design-system"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"GitHub Issues"}),": ",e.jsx(n.a,{href:"https://github.com/npxailsa/design_system/issues",rel:"nofollow",children:"Open a new issue"})]}),`
