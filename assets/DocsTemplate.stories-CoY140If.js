...
name/description pairs inside a styled blue card.`,...(B=(k=a.parameters)==null?void 0:k.docs)==null?void 0:B.description}}};var O,P,F,U,M;r.parameters={...r.parameters,docs:{...(O=r.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...(F=(P=r.parameters)==null?void 0:P.docs)==null?void 0:F.source},description:{story:"Demonstrates PrincipleCards inside the Principles container.",...(M=(U=r.parameters)==null?void 0:U.docs)==null?void 0:M.description}}};var E,H,A,L,W;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => <DocsTemplate>
...
}`,...($=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:$.source},description:{story:"Demonstrates the SizeDemo sub-component for showing icon sizes.",...(oe=(ee=p.parameters)==null?void 0:ee.docs)==null?void 0:oe.description}}};const Ue=["Iconography","BasicPageStructure","TokenTableExample","PrincipleCardsExample","CodeBlockExample","DosDontsExample","IconGalleryExample","SizeDemoExample"];export{t as BasicPageStructure,l as CodeBlockExample,c as DosDontsExample,d as IconGalleryExample,n as Iconography,r as PrincipleCardsExample,p as SizeDemoExample,a as TokenTableExample,Ue as __namedExportsOrder,Fe as default};
