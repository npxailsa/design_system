...
</MuiTabs>`})]}),e.jsx(t.Section,{title:"Overview",children:e.jsx(t.BodyText,{children:"The Tabs component renders a horizontal strip of tab items. Each tab item displays a leading icon, a text label, an optional trailing icon, and an optional badge count. Four visual types are available — two underline variants and two contained (bordered-box) variants — all responsive across small, default, and large sizes."})}),e.jsx(t.Section,{title:"Anatomy",children:e.jsx(t.Anatomy,{preview:e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"default",size:"default",activeId:"tab2"})}),parts:[{id:1,name:"Tab strip",token:"--tab-*",description:"Horizontal flex container holding all tab items."},{id:2,name:"Leading icon",token:"--tab-icon-size",description:"Optional account/person icon shown before the label."},{id:3,name:"Label",token:"--tab-font-size, --tab-font-family",description:"The text that identifies the tab's content section."},{id:4,name:"Trailing icon",token:"--tab-icon-size",description:"Optional arrow-right or chevron-down icon."},{id:5,name:"Badge",token:"--tab-default-badge-bg, --tab-badge-size",description:"Optional rounded count bubble (e.g. 7 unread items)."},{id:6,name:"Underline indicator",token:"--tab-line-width, --tab-line-color-default",description:"Active-state underline for default and secondary types."}]})}),e.jsxs(t.Section,{title:"Types",children:[e.jsxs(t.Subsection,{title:"Default (underline — blue active)",children:[e.jsx(t.BodyText,{children:"Active tab is highlighted with a sky-blue underline indicator. Use for primary navigation."}),e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"default",size:"default",activeId:"tab2"})})]}),e.jsxs(t.Subsection,{title:"Secondary (underline — dark active)",children:[e.jsx(t.BodyText,{children:"Active tab uses a dark/charcoal underline. Use for secondary or nested navigation."}),e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"secondary",size:"default",activeId:"tab2"})})]}),e.jsxs(t.Subsection,{title:"Contained (bordered box — light theme)",children:[e.jsx(t.BodyText,{children:"Each tab is a bordered box. The active tab fills with a solid blue background and white text."}),e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"contained",size:"default",activeId:"tab1"})})]}),e.jsxs(t.Subsection,{title:"Dark Contained (bordered box — dark theme)",children:[e.jsx(t.BodyText,{children:"A contained variant for dark backgrounds. The active tab uses a lighter highlight on dark."}),e.jsx("div",{style:ge,children:e.jsx(i,{items:d,type:"dark-contained",size:"default",activeId:"tab1"})})]})]}),e.jsx(t.Section,{title:"Sizes",children:e.jsx(t.SizeDemo,{rows:[{label:"Small",children:e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"default",size:"small",activeId:"tab2"})})},{label:"Default",children:e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"default",size:"default",activeId:"tab2"})})},{label:"Large",children:e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"default",size:"large",activeId:"tab2"})})}]})}),e.jsxs(t.Section,{title:"States",children:[e.jsxs(t.Subsection,{title:"Default / Active / Disabled",children:[e.jsx(t.BodyText,{children:"Tab item 1 is in default state, item 2 is active, item 4 is disabled."}),e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"default",size:"default",activeId:"tab2"})})]}),e.jsxs(t.Subsection,{title:"With Dropdown indicator",children:[e.jsx(t.BodyText,{children:"Tabs can display a chevron-down trailing icon to indicate a dropdown menu is available."}),e.jsx("div",{style:n,children:e.jsx(i,{items:ue,type:"default",size:"default",activeId:"tab1"})})]})]}),e.jsxs(t.Section,{title:"Icon & Badge Options",children:[e.jsx(t.Subsection,{title:"With leading icon, trailing icon, and badge (default)",children:e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"contained",size:"default",activeId:"tab1",showLeadingIcon:!0,showTrailingIcon:!0,showBadge:!0})})}),e.jsx(t.Subsection,{title:"Without badge",children:e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"contained",size:"default",activeId:"tab1",showBadge:!1})})}),e.jsx(t.Subsection,{title:"Without leading icon",children:e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"contained",size:"default",activeId:"tab1",showLeadingIcon:!1})})}),e.jsx(t.Subsection,{title:"Without trailing icon",children:e.jsx("div",{style:n,children:e.jsx(i,{items:d,type:"contained",size:"default",activeId:"tab1",showTrailingIcon:!1})})})]}),e.jsx(t.Section,{title:"Design Tokens",children:e.jsx(t.TokenTable,{tokens:[{name:"--tab-font-family",description:"Font family for tab labels (--brand-font-primary)"},{name:"--tab-font-weight",description:"Font weight for tab labels (--global-type-weight-light)"},{name:"--tab-focus-ring-color",description:"Focus outline colour (--global-color-primary-blue-blue-400)"},{name:"--tab-underline-track-color",description:"Colour of the inactive underline track (--global-color-neutral-gray-200)"},{name:"--tab-default-line-active",description:"Active underline colour for default type (--global-color-primary-sky-blue)"},{name:"--tab-secondary-line-active",description:"Active underline colour for secondary type (--global-color-neutral-gray-800)"},{name:"--tab-contained-bg-active",description:"Active background for contained tabs (--global-color-primary-blue-blue-500)"},{name:"--tab-contained-text-active",description:"Active text colour for contained tabs (--global-color-base-white)"},{name:"--tab-dark-bg-default",description:"Dark-contained background (--global-color-neutral-gray-700)"},{name:"--tab-dark-text-default",description:"Dark-contained text colour (--global-color-neutral-gray-200)"},{name:"--tab-default-badge-bg",description:"Default badge background (--global-color-primary-sky-blue-100)"},{name:"--tab-contained-radius",description:"Border radius for contained tabs (--global-spacing-radius-6px)"}]})}),e.jsx(t.Section,{title:"Usage Principles",children:e.jsxs(t.Principles,{children:[e.jsx(t.PrincipleCard,{number:1,title:"One active tab at a time",children:"Only one tab should be active per strip. Use controlled state (activeId) to manage which tab is selected and update it via the onTabChange callback."}),e.jsx(t.PrincipleCard,{number:2,title:"Consistent icon and badge usage",children:"If icons or badges are shown, apply them consistently across all tabs in a strip. Mixing tabs with and without icons creates visual imbalance."}),e.jsx(t.PrincipleCard,{number:3,title:"Choose the right type",children:"Use default/secondary underline tabs for page-level navigation. Use contained tabs when tabs sit inside a card or panel with a visible background."})]})}),e.jsx(t.Section,{title:"Dos and Don'ts",children:e.jsx(t.DosDonts,{doItem:{icon:e.jsx("div",{style:n,children:e.jsx(i,{items:d.slice(0,3),type:"default",size:"default",activeId:"tab1"})}),description:"Use tabs to switch between related views at the same hierarchy level."},dontItem:{icon:e.jsx("div",{style:n,children:e.jsx(i,{items:[{id:"a",label:"Tab label"},{id:"b",label:"Tab label"}],type:"default",size:"default",activeId:"a",showLeadingIcon:!1,showTrailingIcon:!1})}),description:"Don't mix tab types or skip icons inconsistently across a single tab strip."}})}),e.jsx(t.Footer,{})]});be.__docgenInfo={description:"",methods:[],displayName:"TabsDocs"};const l=[{id:"tab1",label:"Tab label",count:7},{id:"tab2",label:"Tab label",count:7},{id:"tab3",label:"Tab label",count:7},{id:"tab4",label:"Tab label",count:7,disabled:!0}],D=[{id:"tab1",label:"Tab label",count:7},{id:"tab2",label:"Tab label",count:7,dropdown:!0},{id:"tab3",label:"Tab label",count:7},{id:"tab4",label:"Tab label",count:7,disabled:!0}],c=["small","default","large"],ve=["default","secondary","contained","dark-contained"],s={padding:"var(--global-spacing-sizing-16px)",background:"var(--global-color-neutral-gray-50)",borderRadius:"var(--global-spacing-radius-6px)"},I={...s,background:"var(--global-color-neutral-gray-700)"},o={fontFamily:"var(--brand-font-primary)",fontSize:"11px",fontWeight:600,color:"var(--global-color-neutral-gray-500)",textTransform:"uppercase",letterSpacing:"0.08em",marginBottom:"8px",marginTop:0},r={fontFamily:"var(--brand-font-primary)",fontSize:"13px",fontWeight:600,color:"var(--global-color-neutral-gray-700)",marginBottom:"16px",marginTop:0},Te={title:"Atoms/Tabs",component:i,parameters:{layout:"padded"},argTypes:{type:{control:"select",options:ve},size:{control:"select",options:c},showBadge:{control:"boolean"},showLeadingIcon:{control:"boolean"},showTrailingIcon:{control:"boolean"},activeId:{control:"text"}},args:{items:l,type:"default",size:"default",showBadge:!0,showLeadingIcon:!0,showTrailingIcon:!0,activeId:"tab2"}},p={name:"Documentation",render:()=>e.jsx(be,{}),parameters:{controls:{disable:!0},actions:{disable:!0},layout:"fullscreen",chromatic:{disableSnapshot:!0}}},b={name:"Playground",render:a=>e.jsx("div",{style:a.type==="dark-contained"?I:s,children:e.jsx(i,{...a})})},u={name:"Default",render:a=>e.jsx("div",{style:s,children:e.jsx(i,{...a,type:"default",size:"default",activeId:"tab2"})})},g={name:"Sizes",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-24px)"},children:c.map(a=>e.jsxs("div",{children:[e.jsx("p",{style:o,children:a}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:a,activeId:"tab2"})})]},a))}),parameters:{controls:{disable:!0}}},v={name:"Status / Default (Underline Blue)",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-16px)"},children:c.map(a=>e.jsxs("div",{children:[e.jsx("p",{style:o,children:a}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:a,activeId:"tab2"})})]},a))}),parameters:{controls:{disable:!0}}},y={name:"Status / Secondary (Underline Dark)",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-16px)"},children:c.map(a=>e.jsxs("div",{children:[e.jsx("p",{style:o,children:a}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"secondary",size:a,activeId:"tab2"})})]},a))}),parameters:{controls:{disable:!0}}},m={name:"Status / Contained",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-16px)"},children:c.map(a=>e.jsxs("div",{children:[e.jsx("p",{style:o,children:a}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"contained",size:a,activeId:"tab1"})})]},a))}),parameters:{controls:{disable:!0}}},x={name:"Status / Dark Contained",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-16px)"},children:c.map(a=>e.jsxs("div",{children:[e.jsx("p",{style:o,children:a}),e.jsx("div",{style:I,children:e.jsx(i,{items:l,type:"dark-contained",size:a,activeId:"tab1"})})]},a))}),parameters:{controls:{disable:!0}}},h={name:"Status / With Dropdown Indicator",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-16px)"},children:["default","contained"].map(a=>e.jsxs("div",{children:[e.jsx("p",{style:o,children:a}),e.jsx("div",{style:s,children:e.jsx(i,{items:D,type:a,size:"default",activeId:"tab1"})})]},a))}),parameters:{controls:{disable:!0}}},f={name:"Status / Disabled Tab",render:()=>e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:"default",activeId:"tab1"})}),parameters:{controls:{disable:!0}}},j={name:"Component Breakdown",render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-32px)",padding:"var(--global-spacing-sizing-24px)"},children:[e.jsxs("div",{children:[e.jsx("p",{style:r,children:"Full anatomy — all sub-elements"}),e.jsx("p",{style:{...o,marginBottom:"var(--global-spacing-sizing-12px)"},children:"Each tab item: leading icon + label + trailing icon + badge/count. Disabled tab on right."}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:"default",activeId:"tab2",showLeadingIcon:!0,showTrailingIcon:!0,showBadge:!0})})]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"Without badge"}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:"default",activeId:"tab2",showBadge:!1})})]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"Without icons"}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:"default",activeId:"tab2",showLeadingIcon:!1,showTrailingIcon:!1})})]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"With dropdown indicators"}),e.jsx("div",{style:s,children:e.jsx(i,{items:D,type:"default",size:"default",activeId:"tab1"})})]})]}),parameters:{controls:{disable:!0}}},S={name:"All Interactive States",render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-24px)",padding:"var(--global-spacing-sizing-24px)"},children:[e.jsxs("div",{children:[e.jsx("p",{style:r,children:"Resting (tab 1 active)"}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:"default",activeId:"tab1"})})]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"Active tab 2 selected"}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:"default",activeId:"tab2"})})]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"Tab 4 disabled"}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"default",size:"default",activeId:"tab1"})})]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"Contained — active"}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"contained",size:"default",activeId:"tab2"})})]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"Dark contained — active"}),e.jsx("div",{style:I,children:e.jsx(i,{items:l,type:"dark-contained",size:"default",activeId:"tab2"})})]})]}),parameters:{controls:{disable:!0}}},T={name:"Full Design Matrix (48 variants)",parameters:{layout:"padded",controls:{disable:!0}},render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-32px)"},children:[["default","secondary"].map(a=>e.jsxs("div",{children:[e.jsx("p",{style:r,children:a}),c.map(z=>e.jsxs("div",{style:{marginBottom:"var(--global-spacing-sizing-12px)"},children:[e.jsx("p",{style:o,children:z}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:a,size:z,activeId:"tab2"})})]},z))]},a)),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"contained"}),c.map(a=>e.jsxs("div",{style:{marginBottom:"var(--global-spacing-sizing-12px)"},children:[e.jsx("p",{style:o,children:a}),e.jsx("div",{style:s,children:e.jsx(i,{items:l,type:"contained",size:a,activeId:"tab1"})})]},a))]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"dark-contained"}),c.map(a=>e.jsxs("div",{style:{marginBottom:"var(--global-spacing-sizing-12px)"},children:[e.jsx("p",{style:{...o,color:"var(--global-color-neutral-gray-400)"},children:a}),e.jsx("div",{style:I,children:e.jsx(i,{items:l,type:"dark-contained",size:a,activeId:"tab1"})})]},a))]}),e.jsxs("div",{children:[e.jsx("p",{style:r,children:"With dropdown indicator"}),["default","secondary","contained"].map(a=>e.jsxs("div",{style:{marginBottom:"var(--global-spacing-sizing-12px)"},children:[e.jsx("p",{style:o,children:a}),e.jsx("div",{style:s,children:e.jsx(i,{items:D,type:a,size:"default",activeId:"tab1"})})]},a))]})]})};var k,w,B;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: 'Documentation',
  render: () => <TabsDocs />,
  parameters: {
    controls: {
...
}`,...(W=(C=g.parameters)==null?void 0:C.docs)==null?void 0:W.source}}};var O,P,R;v.parameters={...v.parameters,docs:{...(O=v.parameters)==null?void 0:O.docs,source:{originalSource:`{
...
}`,...(R=(P=v.parameters)==null?void 0:P.docs)==null?void 0:R.source}}};var N,Z,H;y.parameters={...y.parameters,docs:{...(N=y.parameters)==null?void 0:N.docs,source:{originalSource:`{
...
}`,...(H=(Z=y.parameters)==null?void 0:Z.docs)==null?void 0:H.source}}};var X,Y,$;m.parameters={...m.parameters,docs:{...(X=m.parameters)==null?void 0:X.docs,source:{originalSource:`{
...
}`,...($=(Y=m.parameters)==null?void 0:Y.docs)==null?void 0:$.source}}};var q,G,J;x.parameters={...x.parameters,docs:{...(q=x.parameters)==null?void 0:q.docs,source:{originalSource:`{
...
}`,...(V=(Q=h.parameters)==null?void 0:Q.docs)==null?void 0:V.source}}};var ee,ae,te;f.parameters={...f.parameters,docs:{...(ee=f.parameters)==null?void 0:ee.docs,source:{originalSource:`{
...
}`,...(te=(ae=f.parameters)==null?void 0:ae.docs)==null?void 0:te.source}}};var ie,se,le;j.parameters={...j.parameters,docs:{...(ie=j.parameters)==null?void 0:ie.docs,source:{originalSource:`{
...
}`,...(pe=(ce=T.parameters)==null?void 0:ce.docs)==null?void 0:pe.source}}};const Ie=["Documentation","Playground","Default","Sizes","StatusDefault","StatusSecondary","StatusContained","StatusDarkContained","StatusWithDropdown","StatusDisabled","ComponentBreakdown","AllInteractiveStates","FullDesignMatrix"];export{S as AllInteractiveStates,j as ComponentBreakdown,u as Default,p as Documentation,T as FullDesignMatrix,b as Playground,g as Sizes,m as StatusContained,x as StatusDarkContained,v as StatusDefault,f as StatusDisabled,y as StatusSecondary,h as StatusWithDropdown,Ie as __namedExportsOrder,Te as default};
