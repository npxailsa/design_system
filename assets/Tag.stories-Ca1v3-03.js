import{j as e}from"./iframe-Cn9iaYbp.js";import{D as o}from"./DocsTemplate-BufBdqoc.js";import{A as W,P as L}from"./Person-Bjizm5RL.js";import{C as i}from"./Check-CmpC6exz.js";import{c as Qe}from"./createSvgIcon-9NA2Uydt.js";import{L as R}from"./LocalOfferOutlined-D9pHf1dM.js";import"./preload-helper-Dp1pzeXC.js";const Xe="_tag_uy353_10",Ze="_tag__icon_uy353_208",ea="_tag__label_uy353_235",aa="_tag__count_uy353_247",la="_tag__remove_uy353_281",t={tag:Xe,"tag--small":"_tag--small_uy353_41","tag--large":"_tag--large_uy353_49","tag--default":"_tag--default_uy353_59","tag--blue":"_tag--blue_uy353_65","tag--seafoam":"_tag--seafoam_uy353_71","tag--yellow":"_tag--yellow_uy353_77","tag--dark":"_tag--dark_uy353_83","tag--navy":"_tag--navy_uy353_89","tag--red":"_tag--red_uy353_95","tag--green":"_tag--green_uy353_101","tag--purple":"_tag--purple_uy353_107","tag--info":"_tag--info_uy353_113","tag--outline":"_tag--outline_uy353_121","tag--selected":"_tag--selected_uy353_135","tag--interactive":"_tag--interactive_uy353_185","tag--disabled":"_tag--disabled_uy353_200",tag__icon:Ze,"tag__icon-svg":"_tag__icon-svg_uy353_215",tag__label:ea,tag__count:aa,tag__remove:la},a=({label:l="Label",size:r="default",colour:n="blue",variant:c="filled",leadingIcon:s,showLeadingIcon:m=!1,trailingIcon:x,showTrailingIcon:Ue=!1,showRemove:Ge=!1,count:O,showCount:Me=!1,selected:F=!1,disabled:g=!1,onClick:u,onRemove:f,className:He=""})=>{const Ke=[t.tag,t[`tag--${r}`],t[`tag--${n}`],t[`tag--${c}`],F?t["tag--selected"]:"",g?t["tag--disabled"]:"",u||f?t["tag--interactive"]:"",He].filter(Boolean).join(" "),Ye=d=>{!g&&u&&(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),u())},Je=d=>{!g&&f&&(d.key==="Enter"||d.key===" ")&&(d.preventDefault(),d.stopPropagation(),f())};return e.jsxs("span",{className:Ke,onClick:!g&&u?u:void 0,onKeyDown:Ye,role:u?"button":void 0,tabIndex:u&&!g?0:void 0,"aria-pressed":u&&F?!0:void 0,"aria-disabled":g?!0:void 0,children:[m&&s&&e.jsx("span",{className:t.tag__icon,"aria-hidden":"true",children:e.jsx(s,{className:t["tag__icon-svg"]})}),e.jsx("span",{className:t.tag__label,children:l}),Me&&O!==void 0&&e.jsx("span",{className:t.tag__count,children:O}),Ue&&x&&e.jsx("span",{className:t.tag__icon,"aria-hidden":"true",children:e.jsx(x,{className:t["tag__icon-svg"]})}),Ge&&e.jsx("button",{type:"button",className:t.tag__remove,onClick:d=>{d.stopPropagation(),!g&&f&&f()},onKeyDown:Je,"aria-label":"Remove tag",tabIndex:g?-1:0,disabled:g,children:e.jsx("svg",{width:"8",height:"8",viewBox:"0 0 8 8",fill:"none",xmlns:"http://www.w3.org/2000/svg","aria-hidden":"true",children:e.jsx("path",{d:"M7 1L1 7M1 1L7 7",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"})})})]})};a.__docgenInfo={description:`Tag — A compact pill-shaped label used to categorise, filter, or annotate
...
// Disabled
<Tag colour="red" label="Restricted" disabled />`}),e.jsxs(o.Principles,{children:[e.jsxs(o.PrincipleCard,{number:1,title:"Semantic Colour",children:["Choose the colour variant based on its semantic meaning, not aesthetics. Use"," ",e.jsx("strong",{children:"red"})," for errors, ",e.jsx("strong",{children:"green"})," for success, ",e.jsx("strong",{children:"yellow"})," ","for warnings, and ",e.jsx("strong",{children:"info/blue"})," for informational categories. Reserve"," ",e.jsx("strong",{children:"dark"})," and ",e.jsx("strong",{children:"navy"})," for high-emphasis neutral labels."]}),e.jsx(o.PrincipleCard,{number:2,title:"Concise Labels",children:"Tag labels should be 1–3 words. Long text forces truncation at 160px. If content is longer, consider a different component (e.g. a Badge or a full Label)."}),e.jsx(o.PrincipleCard,{number:3,title:"Group Consistently",children:"When displaying a set of tags, keep the same size and variant consistent across the group. Mixing sizes within a row creates visual noise. Reserve size variation for deliberate hierarchy signals."})]}),e.jsx(o.DosDonts,{doItem:{icon:e.jsxs("div",{style:{display:"flex",gap:"var(--global-spacing-sizing-8px)"},children:[e.jsx(a,{colour:"green",label:"Approved",showLeadingIcon:!0,leadingIcon:i}),e.jsx(a,{colour:"red",label:"Rejected"}),e.jsx(a,{colour:"yellow",label:"Pending"})]}),label:"Semantic colours",description:"Use colour variants that reflect semantic meaning — green for success, red for errors, yellow for warnings."},dontItem:{icon:e.jsxs("div",{style:{display:"flex",gap:"var(--global-spacing-sizing-8px)"},children:[e.jsx(a,{colour:"purple",label:"Approved"}),e.jsx(a,{colour:"blue",label:"Rejected"}),e.jsx(a,{colour:"navy",label:"Pending"})]}),label:"Mismatched colours",description:"Don't use arbitrary colours that contradict meaning. Users rely on colour to quickly understand status."}}),e.jsx(o.Footer,{})]});B.__docgenInfo={description:"",methods:[],displayName:"TagDocs"};const ua={title:"Foundation/Tag",component:a,parameters:{layout:"centered",docs:{page:()=>e.jsx(B,{})}},argTypes:{size:{control:"select",options:["small","default","large"]},colour:{control:"select",options:["default","blue","seafoam","yellow","dark","navy","red","green","purple","info"]},variant:{control:"select",options:["filled","outline"]},leadingIcon:{control:"select",options:["None","Person","Check","Star","Tag"],mapping:{None:void 0,Person:L,Check:i,Star:b,Tag:R}},showLeadingIcon:{control:"boolean"},trailingIcon:{control:"select",options:["None","Person","Check","Star","Tag"],mapping:{None:void 0,Person:L,Check:i,Star:b,Tag:R}},showTrailingIcon:{control:"boolean"},showRemove:{control:"boolean"},showCount:{control:"boolean"},count:{control:"number"},selected:{control:"boolean"},disabled:{control:"boolean"},label:{control:"text"}}},h={render:()=>e.jsx(B,{}),parameters:{layout:"fullscreen",controls:{disable:!0},actions:{disable:!0}}},y={args:{label:"Label",colour:"blue",size:"default",variant:"filled"}},v={render:()=>e.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",padding:"16px"},children:["default","blue","seafoam","yellow","dark","navy","red","green","purple","info"].map(l=>e.jsx(a,{colour:l,label:l},l))}),parameters:{controls:{disable:!0}}},w={render:()=>e.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",padding:"16px"},children:["default","blue","seafoam","yellow","dark","navy","red","green","purple","info"].map(l=>e.jsx(a,{colour:l,variant:"outline",label:l},l))}),parameters:{controls:{disable:!0}}},j={render:()=>e.jsxs("div",{style:{display:"flex",alignItems:"center",flexWrap:"wrap",gap:"12px",padding:"16px"},children:[e.jsx(a,{size:"small",colour:"blue",label:"Small"}),e.jsx(a,{size:"default",colour:"blue",label:"Default"}),e.jsx(a,{size:"large",colour:"blue",label:"Large"})]}),parameters:{controls:{disable:!0}}},T={render:()=>e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",padding:"16px"},children:[e.jsx(a,{colour:"blue",label:"Person",showLeadingIcon:!0,leadingIcon:L}),e.jsx(a,{colour:"green",label:"Verified",showLeadingIcon:!0,leadingIcon:i}),e.jsx(a,{colour:"purple",label:"Featured",showLeadingIcon:!0,leadingIcon:b}),e.jsx(a,{colour:"yellow",label:"Tagged",size:"large",showLeadingIcon:!0,leadingIcon:R}),e.jsx(a,{colour:"info",size:"small",label:"Small icon",showLeadingIcon:!0,leadingIcon:L})]}),parameters:{controls:{disable:!0}}},I={render:()=>e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",padding:"16px"},children:[e.jsx(a,{colour:"blue",label:"Next",showTrailingIcon:!0,trailingIcon:i}),e.jsx(a,{colour:"green",label:"Verified",showTrailingIcon:!0,trailingIcon:i}),e.jsx(a,{colour:"purple",label:"Featured",showLeadingIcon:!0,leadingIcon:b,showTrailingIcon:!0,trailingIcon:i}),e.jsx(a,{colour:"yellow",label:"Tagged",size:"large",showTrailingIcon:!0,trailingIcon:R})]}),parameters:{controls:{disable:!0}}},z={render:()=>e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",padding:"16px"},children:[e.jsx(a,{colour:"blue",label:"Issues",showCount:!0,count:12}),e.jsx(a,{colour:"red",label:"Errors",showCount:!0,count:3}),e.jsx(a,{colour:"yellow",label:"Warnings",showCount:!0,count:7}),e.jsx(a,{colour:"green",label:"Passed",showCount:!0,count:99}),e.jsx(a,{colour:"dark",label:"Total",showCount:!0,count:114})]}),parameters:{controls:{disable:!0}}},k={render:()=>e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",padding:"16px"},children:[e.jsx(a,{colour:"blue",label:"Category",showRemove:!0}),e.jsx(a,{colour:"seafoam",label:"Topic",showRemove:!0}),e.jsx(a,{colour:"purple",label:"Label",showRemove:!0}),e.jsx(a,{colour:"red",label:"Remove me",showRemove:!0})]}),parameters:{controls:{disable:!0}}},_={render:()=>e.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",padding:"16px"},children:["blue","green","purple","red","info","default"].map(l=>e.jsxs("div",{style:{display:"flex",gap:"6px"},children:[e.jsx(a,{colour:l,label:"Off"}),e.jsx(a,{colour:l,label:"On",selected:!0})]},l))}),parameters:{controls:{disable:!0}}},N=["default","blue","seafoam","yellow","dark","navy","red","green","purple","info"],oa=({colour:l="blue",count:r=1,size:n="md",variant:c="filled"})=>{const s=`var(--badge-size-${n})`,m=`var(--badge-font-size-${n})`,x=c==="outline";return e.jsx("span",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:s,height:s,minWidth:s,borderRadius:"var(--badge-border-radius)",border:`var(--badge-border-width) solid var(--badge-border-${l})`,background:x?"transparent":`var(--badge-bg-${l})`,color:x?`var(--badge-bg-${l==="dark"?"dark":l==="navy"?"navy":l})`:`var(--badge-color-${l})`,fontFamily:"var(--badge-font-family)",fontWeight:"var(--badge-font-weight)",fontSize:m,letterSpacing:"var(--badge-letter-spacing)",lineHeight:1,userSelect:"none",flexShrink:0,transition:"background var(--badge-transition-duration) var(--badge-transition-easing)"},children:r})},ra=({colour:l="blue",...r})=>{const n=l==="dark"?"var(--global-color-base-black)":l==="navy"?"var(--global-color-secondary-navy)":`var(--badge-color-${l})`,c=`var(--badge-size-${r.size??"md"})`,s=`var(--badge-font-size-${r.size??"md"})`;return e.jsx("span",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",width:c,height:c,minWidth:c,borderRadius:"var(--badge-border-radius)",border:`var(--badge-border-width) solid var(--badge-border-${l})`,background:"transparent",color:n,fontFamily:"var(--badge-font-family)",fontWeight:700,fontSize:s,letterSpacing:"var(--badge-letter-spacing)",lineHeight:1,userSelect:"none",flexShrink:0},children:r.count??1})},S={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px",padding:"16px"},children:[["xs","sm","md","lg"].map(l=>e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",alignItems:"center"},children:[e.jsx("span",{style:{fontFamily:"var(--font-family-secondary)",fontSize:"11px",color:"#6d7280",minWidth:"32px",flexShrink:0},children:l}),N.map(r=>e.jsx(oa,{colour:r,size:l,count:1,variant:"filled"},r))]},l)),e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",alignItems:"center"},children:[e.jsx("span",{style:{fontFamily:"var(--font-family-secondary)",fontSize:"11px",color:"#6d7280",minWidth:"32px",flexShrink:0},children:"out"}),N.map(l=>e.jsx(ra,{colour:l,size:"md",count:1},l))]})]}),parameters:{layout:"padded",controls:{disable:!0}}},C={render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"12px",padding:"16px"},children:["small","default","large"].map(l=>e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"6px",alignItems:"center"},children:[e.jsx("span",{style:{fontFamily:"var(--font-family-secondary)",fontSize:"11px",color:"#6d7280",minWidth:"52px",flexShrink:0},children:l}),["default","blue","seafoam","yellow","dark","navy","red","green","purple","info"].map(r=>e.jsx(a,{size:l,colour:r,label:"Label"},r))]},l))}),parameters:{layout:"padded",controls:{disable:!0}}};var A,P,V,$,E;h.parameters={...h.parameters,docs:{...(A=h.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => <TagDocs />,
  parameters: {
    layout: 'fullscreen',
    controls: {
...
}`,...(V=(P=h.parameters)==null?void 0:P.docs)==null?void 0:V.source},description:{story:"Full documentation page for the Tag component.",...(E=($=h.parameters)==null?void 0:$.docs)==null?void 0:E.description}}};var q,U,G,M,H;y.parameters={...y.parameters,docs:{...(q=y.parameters)==null?void 0:q.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    colour: 'blue',
    size: 'default',
...
}`,...(G=(U=y.parameters)==null?void 0:U.docs)==null?void 0:G.source},description:{story:"Default Tag — the most common usage.",...(H=(M=y.parameters)==null?void 0:M.docs)==null?void 0:H.description}}};var K,Y,J,Q,X;v.parameters={...v.parameters,docs:{...(K=v.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexWrap: 'wrap',
    gap: '8px',
...
}`,...(ne=(te=j.parameters)==null?void 0:te.docs)==null?void 0:ne.source},description:{story:"All three sizes.",...(ie=(se=j.parameters)==null?void 0:se.docs)==null?void 0:ie.description}}};var de,ce,ge,ue,pe;T.parameters={...T.parameters,docs:{...(de=T.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexWrap: 'wrap',
    gap: '8px',
...
}`,...(ge=(ce=T.parameters)==null?void 0:ce.docs)==null?void 0:ge.source},description:{story:"Tags with leading icons.",...(pe=(ue=T.parameters)==null?void 0:ue.docs)==null?void 0:pe.description}}};var be,me,xe,fe,he;I.parameters={...I.parameters,docs:{...(be=I.parameters)==null?void 0:be.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexWrap: 'wrap',
    gap: '8px',
...
}`,...(ke=(ze=k.parameters)==null?void 0:ze.docs)==null?void 0:ke.source},description:{story:"Removable tags with the dismiss × button.",...(Se=(_e=k.parameters)==null?void 0:_e.docs)==null?void 0:Se.description}}};var Ce,Le,We,De,Re;_.parameters={..._.parameters,docs:{...(Ce=_.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexWrap: 'wrap',
    gap: '8px',
...
}`,...(We=(Le=_.parameters)==null?void 0:Le.docs)==null?void 0:We.source},description:{story:"Selected state — active/pressed tags.",...(Re=(De=_.parameters)==null?void 0:De.docs)==null?void 0:Re.description}}};var Be,Oe,Fe,Ne,Ae;S.parameters={...S.parameters,docs:{...(Be=S.parameters)==null?void 0:Be.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
...
}`,...(Fe=(Oe=S.parameters)==null?void 0:Oe.docs)==null?void 0:Fe.source},description:{story:`Circular notification badges in all colour variants and sizes.
Use these to indicate counts, alerts, or status dots on UI elements.`,...(Ae=(Ne=S.parameters)==null?void 0:Ne.docs)==null?void 0:Ae.description}}};var Pe,Ve,$e,Ee,qe;C.parameters={...C.parameters,docs:{...(Pe=C.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
    gap: '12px',
...
}`,...($e=(Ve=C.parameters)==null?void 0:Ve.docs)==null?void 0:$e.source},description:{story:"All sizes × all colours matrix.",...(qe=(Ee=C.parameters)==null?void 0:Ee.docs)==null?void 0:qe.description}}};const pa=["Documentation","Default","ColourVariants","OutlineVariants","Sizes","WithLeadingIcon","WithTrailingIcon","WithCount","Removable","SelectedState","NotificationBadges","AllVariants"];export{C as AllVariants,v as ColourVariants,y as Default,h as Documentation,S as NotificationBadges,w as OutlineVariants,k as Removable,_ as SelectedState,j as Sizes,z as WithCount,T as WithLeadingIcon,I as WithTrailingIcon,pa as __namedExportsOrder,ua as default};
