...
}`,...(v=(w=r.parameters)==null?void 0:w.docs)==null?void 0:v.source},description:{story:"Full documentation page for the Button component.",...(L=(j=r.parameters)==null?void 0:j.docs)==null?void 0:L.description}}};var z,B,T,F,D;t.parameters={...t.parameters,docs:{...(z=t.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    label: 'Label',
    variant: 'filled',
    size: 'default'
  }
}`,...(T=(B=t.parameters)==null?void 0:B.docs)==null?void 0:T.source},description:{story:"Default button — filled variant with label.",...(D=(F=t.parameters)==null?void 0:F.docs)==null?void 0:D.description}}};var S,k,O,A,P;s.parameters={...s.parameters,docs:{...(S=s.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    gap: '12px',
...
}`,...(O=(k=s.parameters)==null?void 0:k.docs)==null?void 0:O.source},description:{story:"Both variants side by side.",...(P=(A=s.parameters)==null?void 0:A.docs)==null?void 0:P.description}}};var W,C,U,H,E;d.parameters={...d.parameters,docs:{...(W=d.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    gap: '12px',
...
}`,...(U=(C=d.parameters)==null?void 0:C.docs)==null?void 0:U.source},description:{story:"All three sizes.",...(E=(H=d.parameters)==null?void 0:H.docs)==null?void 0:E.description}}};var G,V,N,M,_;c.parameters={...c.parameters,docs:{...(G=c.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
...
}`,...(Z=(Y=p.parameters)==null?void 0:Y.docs)==null?void 0:Z.source},description:{story:"Buttons with both leading and trailing icons.",...(ee=($=p.parameters)==null?void 0:$.docs)==null?void 0:ee.description}}};var ne,ae,ie,le,oe;b.parameters={...b.parameters,docs:{...(ne=b.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    gap: '12px',
...
}`,...(ie=(ae=b.parameters)==null?void 0:ae.docs)==null?void 0:ie.source},description:{story:"Icon-only buttons — circular, no label.",...(oe=(le=b.parameters)==null?void 0:le.docs)==null?void 0:oe.description}}};var re,te,se,de,ce;u.parameters={...u.parameters,docs:{...(re=u.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
...
}`,...(Ie=(he=x.parameters)==null?void 0:he.docs)==null?void 0:Ie.source},description:{story:"Full variant, size, and state matrix.",...(fe=(ye=x.parameters)==null?void 0:ye.docs)==null?void 0:fe.description}}};const Ae=["Documentation","Default","Variants","Sizes","WithLeadingIcon","WithTrailingIcon","WithBothIcons","IconOnly","Loading","Disabled","AllVariants"];export{x as AllVariants,t as Default,m as Disabled,r as Documentation,b as IconOnly,u as Loading,d as Sizes,s as Variants,p as WithBothIcons,c as WithLeadingIcon,g as WithTrailingIcon,Ae as __namedExportsOrder,Oe as default};
