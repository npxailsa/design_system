import{j as e}from"./iframe-UCas0wem.js";import{D as o}from"./DocsTemplate-LDj75BUA.js";import{A as n,P as i}from"./Person-Cur0NYnU.js";import{D as Ie,A as I}from"./Download-Cpq_DW-2.js";import{E as w}from"./Edit-DSw7ZOvF.js";import{B as _e}from"./Button-Dy7upYei.js";import{C as T}from"./Check-BQZk_7HW.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-0haEw4Kn.js";const l={"ghost-btn":"_ghost-btn_ihpcz_20","ghost-btn--disabled":"_ghost-btn--disabled_ihpcz_71","ghost-btn--loading":"_ghost-btn--loading_ihpcz_111","ghost-btn--small":"_ghost-btn--small_ihpcz_118","ghost-btn--large":"_ghost-btn--large_ihpcz_125","ghost-btn--icon-only":"_ghost-btn--icon-only_ihpcz_133","ghost-btn--full-width":"_ghost-btn--full-width_ihpcz_151","ghost-btn__icon":"_ghost-btn__icon_ihpcz_156","ghost-btn__icon-svg":"_ghost-btn__icon-svg_ihpcz_163","ghost-btn__label":"_ghost-btn__label_ihpcz_182","ghost-btn__spinner":"_ghost-btn__spinner_ihpcz_189","ghost-btn-spin":"_ghost-btn-spin_ihpcz_1"},a=({label:z="Label",size:ye="default",type:fe="button",leadingIcon:x,showLeadingIcon:we=!1,trailingIcon:j,showTrailingIcon:ve=!1,iconOnly:r=!1,loading:s=!1,disabled:y=!1,fullWidth:ze=!1,onClick:je,className:Le="",ariaLabel:L})=>{const Te=[l["ghost-btn"],l[`ghost-btn--${ye}`],r?l["ghost-btn--icon-only"]:"",s?l["ghost-btn--loading"]:"",y?l["ghost-btn--disabled"]:"",ze?l["ghost-btn--full-width"]:"",Le].filter(Boolean).join(" "),f=s,Be=we&&x&&!f;return e.jsxs("button",{type:fe,className:Te,onClick:!y&&!s?je:void 0,disabled:y||s,"aria-label":r?L??z:L,"aria-busy":s||void 0,children:[f&&e.jsx("span",{className:l["ghost-btn__spinner"],"aria-hidden":"true"}),Be&&e.jsx("span",{className:l["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(x,{className:l["ghost-btn__icon-svg"]})}),!r&&e.jsx("span",{className:l["ghost-btn__label"],children:z}),ve&&j&&!r&&e.jsx("span",{className:l["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(j,{className:l["ghost-btn__icon-svg"]})}),r&&!f&&x&&e.jsx("span",{className:l["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(x,{className:l["ghost-btn__icon-svg"]})})]})};a.__docgenInfo={description:`GhostButton — Low-emphasis interactive control with a ghost/outline style.
...
}`,...(O=(A=c.parameters)==null?void 0:A.docs)==null?void 0:O.source},description:{story:"Default ghost button with trailing icon.",...(P=(k=c.parameters)==null?void 0:k.docs)==null?void 0:P.description}}};var E,W,U,C,N;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
...
}`,...(U=(W=d.parameters)==null?void 0:W.docs)==null?void 0:U.source},description:{story:"All three sizes.",...(N=(C=d.parameters)==null?void 0:C.docs)==null?void 0:N.description}}};var q,V,R,H,M;g.parameters={...g.parameters,docs:{...(q=g.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
...
}`,...(R=(V=g.parameters)==null?void 0:V.docs)==null?void 0:R.source},description:{story:"With a leading icon.",...(M=(H=g.parameters)==null?void 0:H.docs)==null?void 0:M.description}}};var $,J,K,Q,X;p.parameters={...p.parameters,docs:{...($=p.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
