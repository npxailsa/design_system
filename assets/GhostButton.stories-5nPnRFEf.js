import{j as e}from"./iframe-BJvLnmTr.js";import{D as i}from"./DocsTemplate-CGfNJcNy.js";import{A as n,P as l}from"./Person-ChL5VuyY.js";import{D as Oe,A as v}from"./Download-p46EyReX.js";import{E as T}from"./Edit-DP9PYTKi.js";import{B as qe}from"./Button-D8JTfcYf.js";import{C as O}from"./Check-DncGnMyf.js";import"./preload-helper-Dp1pzeXC.js";import"./createSvgIcon-CjLMVDwt.js";const o={"ghost-btn":"_ghost-btn_66ze4_24","ghost-btn--ghost":"_ghost-btn--ghost_66ze4_79","ghost-btn--disabled":"_ghost-btn--disabled_66ze4_86","ghost-btn--loading":"_ghost-btn--loading_66ze4_126","ghost-btn--link":"_ghost-btn--link_66ze4_136","ghost-btn--extra-small":"_ghost-btn--extra-small_66ze4_198","ghost-btn--small":"_ghost-btn--small_66ze4_206","ghost-btn--large":"_ghost-btn--large_66ze4_214","ghost-btn--icon-only":"_ghost-btn--icon-only_66ze4_225","ghost-btn--borderless":"_ghost-btn--borderless_66ze4_253","ghost-btn--full-width":"_ghost-btn--full-width_66ze4_265","ghost-btn__icon":"_ghost-btn__icon_66ze4_273","ghost-btn__icon-svg":"_ghost-btn__icon-svg_66ze4_280","ghost-btn__label":"_ghost-btn__label_66ze4_305","ghost-btn__spinner":"_ghost-btn__spinner_66ze4_315","ghost-btn-spin":"_ghost-btn-spin_66ze4_1"},a=({variant:c="ghost",label:B="Label",size:Fe="default",type:Ae="button",leadingIcon:z,showLeadingIcon:De=!1,trailingIcon:G,showTrailingIcon:Ue=!1,iconOnly:r=!1,borderless:Se=!1,loading:d=!1,disabled:L=!1,fullWidth:Pe=!1,onClick:Ce,className:Ee="",ariaLabel:_})=>{const We=[o["ghost-btn"],o[`ghost-btn--${c}`],o[`ghost-btn--${Fe}`],r?o["ghost-btn--icon-only"]:"",r&&Se?o["ghost-btn--borderless"]:"",d?o["ghost-btn--loading"]:"",L?o["ghost-btn--disabled"]:"",Pe?o["ghost-btn--full-width"]:"",Ee].filter(Boolean).join(" "),j=d,Ve=De&&z&&!j;return e.jsxs("button",{type:Ae,className:We,onClick:!L&&!d?Ce:void 0,disabled:L||d,"aria-label":r?_??B:_,"aria-busy":d||void 0,children:[j&&e.jsx("span",{className:o["ghost-btn__spinner"],"aria-hidden":"true"}),Ve&&e.jsx("span",{className:o["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(z,{className:o["ghost-btn__icon-svg"]})}),!r&&e.jsx("span",{className:o["ghost-btn__label"],children:B}),Ue&&G&&!r&&e.jsx("span",{className:o["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(G,{className:o["ghost-btn__icon-svg"]})}),r&&!j&&z&&e.jsx("span",{className:o["ghost-btn__icon"],"aria-hidden":"true",children:e.jsx(z,{className:o["ghost-btn__icon-svg"]})})]})};a.__docgenInfo={description:`GhostButton — Low-emphasis interactive control with ghost/outline or link style.
...
}`,...(D=(A=f.parameters)==null?void 0:A.docs)==null?void 0:D.source}}};var U,S,P,C,E;g.parameters={...g.parameters,docs:{...(U=g.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    variant: 'ghost',
    label: 'Label',
    size: 'default',
...
}`,...(me=(xe=m.parameters)==null?void 0:xe.docs)==null?void 0:me.source},description:{story:"Loading state — spinner replaces leading icon.",...(ye=(we=m.parameters)==null?void 0:we.docs)==null?void 0:ye.description}}};var ze,fe,ve,Le,je;w.parameters={...w.parameters,docs:{...(ze=w.parameters)==null?void 0:ze.docs,source:{originalSource:`{
  render: () => <div style={{
    display: 'flex',
    alignItems: 'center',
    flexWrap: 'wrap',
