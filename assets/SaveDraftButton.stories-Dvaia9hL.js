...
/>`}),e.jsxs(a.Principles,{children:[e.jsxs(a.PrincipleCard,{number:1,title:"Drive status from your save logic",children:["Map your application's save lifecycle (idle → saving → saved / error) directly to the"," ",e.jsx("code",{children:"status"})," prop. Never manually set colours or labels — let the token system handle visual consistency."]}),e.jsx(a.PrincipleCard,{number:2,title:"Persist the button across all states",children:"Keep the button visible in all states, including saved and error. Hiding it removes important feedback for the user about their document's save status."}),e.jsx(a.PrincipleCard,{number:3,title:"Only one SaveDraftButton per form",children:"Use a single SaveDraftButton per document or form scope. Multiple buttons suggest multiple save targets, which is confusing. If you need section-level saves, use text links instead."})]}),e.jsx(a.Footer,{})]});g.__docgenInfo={description:"",methods:[],displayName:"SaveDraftButtonDocs"};const R=["default","auto-saving","saving","saved","error","disabled","focused"],ee={title:"Atoms/Buttons/Save Draft Button",component:s,parameters:{docs:{page:()=>e.jsx(g,{})}},argTypes:{status:{control:"select",options:R,description:"Drives the label, background, border, and text colour of the button"},label:{control:"text",description:"Overrides the auto-derived label for the current status"}},args:{status:"default"}},n={render:()=>e.jsx(g,{}),parameters:{controls:{disable:!0},actions:{disable:!0},chromatic:{disableSnapshot:!0}}},o={args:{status:"default"}},i={name:"Auto-saving",args:{status:"auto-saving"}},l={args:{status:"saving"}},d={args:{status:"saved"}},c={args:{status:"error"}},u={args:{status:"disabled"}},p={name:"All States",render:()=>e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"var(--global-spacing-sizing-16px)",padding:"var(--global-spacing-sizing-24px)",alignItems:"flex-start"},children:R.map(t=>e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"var(--global-spacing-sizing-20px)"},children:[e.jsx(s,{status:t}),e.jsx("span",{style:{fontFamily:"var(--brand-font-primary)",fontSize:"var(--global-type-size-primary-label-xs)",color:"var(--global-color-neutral-gray-500)",textTransform:"capitalize"},children:t})]},t))}),parameters:{controls:{disable:!0}}};var x,h,y;n.parameters={...n.parameters,docs:{...(x=n.parameters)==null?void 0:x.docs,source:{originalSource:`{
...
}`,...(w=(D=i.parameters)==null?void 0:D.docs)==null?void 0:w.source}}};var B,T,A;l.parameters={...l.parameters,docs:{...(B=l.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    status: 'saving'
  }
}`,...(A=(T=l.parameters)==null?void 0:T.docs)==null?void 0:A.source}}};var z,F,E;d.parameters={...d.parameters,docs:{...(z=d.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
    status: 'saved'
  }
...
}`,...(I=(L=c.parameters)==null?void 0:L.docs)==null?void 0:I.source}}};var U,M,N;u.parameters={...u.parameters,docs:{...(U=u.parameters)==null?void 0:U.docs,source:{originalSource:`{
  args: {
    status: 'disabled'
  }
}`,...(N=(M=u.parameters)==null?void 0:M.docs)==null?void 0:N.source}}};var H,O,P;p.parameters={...p.parameters,docs:{...(H=p.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: 'All States',
  render: () => <div style={{
    display: 'flex',
...
}`,...(P=(O=p.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};const ae=["Documentation","Default","AutoSaving","Saving","Saved","Error","Disabled","AllStates"];export{p as AllStates,i as AutoSaving,o as Default,u as Disabled,n as Documentation,c as Error,d as Saved,l as Saving,ae as __namedExportsOrder,ee as default};
