import styles from "./OutlineIconsNameCubeOutlineCategoryOutline.module.css";

export interface IOutlineIconsNameCubeOutlineCategoryOutlineProps {
  name?:
...
export const OutlineIconsNameCubeOutlineCategoryOutline = ({
  name = "equalizer-outline",
  category = "outline",
  className,
  ...props
}: IOutlineIconsNameCubeOutlineCategoryOutlineProps): JSX.Element => {
  ...
  return (
    <svg
      className={
        styles.outlineIconsNameCubeOutlineCategoryOutline +
        " " +
        className +
        " " +
        variantsClassName
    ...
    >
      <path
        d="M105 82.5C105 84.4 103.95 86.05 102.35 86.9L62.85 109.1C62.05 109.7 61.05 110 60 110C58.95 110 57.95 109.7 57.15 109.1L17.65 86.9C16.05 86.05 15 84.4 15 82.5V37.5C15 35.6 16.05 33.95 17.65 33.1L57.15 10.9C57.95 10.3 58.95 10 60 10C61.05 10 62.05 10.3 62.85 10.9L102.35 33.1C103.95 33.95 105 35.6 105 37.5V82.5ZM60 20.75L30.2 37.5L60 54.25L89.8 37.5L60 20.75ZM25 79.55L55 96.45V62.9L25 46.05V79.55ZM95 79.55V46.05L65 62.9V96.45L95 79.55Z"
