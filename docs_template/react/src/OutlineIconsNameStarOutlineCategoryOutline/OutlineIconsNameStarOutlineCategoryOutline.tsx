import styles from "./OutlineIconsNameStarOutlineCategoryOutline.module.css";

export interface IOutlineIconsNameStarOutlineCategoryOutlineProps {
  name?:
...
export const OutlineIconsNameStarOutlineCategoryOutline = ({
  name = "equalizer-outline",
  category = "outline",
  className,
  ...props
}: IOutlineIconsNameStarOutlineCategoryOutlineProps): JSX.Element => {
  ...
  return (
    <svg
      className={
        styles.outlineIconsNameStarOutlineCategoryOutline +
        " " +
        className +
        " " +
        variantsClassName
    ...
    >
      <path
        d="M60 76.95L41.2 88.3L46.15 66.9L29.55 52.5L51.45 50.65L60 30.45L68.55 50.65L90.45 52.5L73.85 66.9L78.8 88.3M110 46.2L74.05 43.15L60 10L45.95 43.15L10 46.2L37.25 69.85L29.1 105L60 86.35L90.9 105L82.7 69.85L110 46.2Z"
