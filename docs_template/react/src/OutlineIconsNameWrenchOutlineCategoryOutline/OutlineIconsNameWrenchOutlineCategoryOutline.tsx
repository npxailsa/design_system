import styles from "./OutlineIconsNameWrenchOutlineCategoryOutline.module.css";

export interface IOutlineIconsNameWrenchOutlineCategoryOutlineProps {
  name?:
...
export const OutlineIconsNameWrenchOutlineCategoryOutline = ({
  name = "equalizer-outline",
  category = "outline",
  className,
  ...props
}: IOutlineIconsNameWrenchOutlineCategoryOutlineProps): JSX.Element => {
  ...
  return (
    <svg
      className={
        styles.outlineIconsNameWrenchOutlineCategoryOutline +
        " " +
        className +
        " " +
        variantsClassName
    ...
    >
      <path
        d="M113.05 94.9999L67.6501 49.5499C72.3001 37.8499 70.0001 24.0499 60.4501 14.5499C48.9501 3.04986 31.0501 1.99986 18.3001 11.2999L37.5001 30.5499L30.4001 37.4999L11.2501 18.4499C1.95005 31.1499 3.00005 49.0999 14.5001 60.5499C23.8001 69.8499 37.3501 72.2999 48.9501 67.9499L94.5001 113.5C96.4501 115.45 99.6001 115.45 101.55 113.5L113.05 102C115 99.9999 115 96.9499 113.05 94.9999ZM98.0501 102.95L50.7501 55.6499C47.7001 57.8999 44.3 59.2499 40.75 59.7499C33.95 60.7499 26.8001 58.6999 21.6001 53.4999C16.8501 48.7999 14.6501 42.4999 15.0001 36.2999L30.4501 51.7499L51.6501 30.5499L36.2 14.9999C42.5 14.7499 48.6501 16.9499 53.4001 21.6499C58.8001 27.0499 60.8501 34.4999 59.6001 41.4499C59.0001 44.9999 57.5001 48.2999 55.2001 51.2499L102.5 98.4999L98.0501 102.95Z"
