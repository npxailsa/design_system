import styles from "./OutlineIconsNameArchiveOutlineCategoryOutline.module.css";

export interface IOutlineIconsNameArchiveOutlineCategoryOutlineProps {
  name?:
...
export const OutlineIconsNameArchiveOutlineCategoryOutline = ({
  name = "equalizer-outline",
  category = "outline",
  className,
  ...props
}: IOutlineIconsNameArchiveOutlineCategoryOutlineProps): JSX.Element => {
  ...
  return (
    <svg
      className={
        styles.outlineIconsNameArchiveOutlineCategoryOutline +
        " " +
        className +
        " " +
        variantsClassName
    ...
    >
      <path
        d="M100 105H20V50H30V95H90V50H100V105ZM15 15H105V45H15V15ZM47.5 55H72.5C73.9 55 75 56.1 75 57.5V65H45V57.5C45 56.1 46.1 55 47.5 55ZM25 25V35H95V25H25Z"
