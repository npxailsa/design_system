import styles from "./OutlineIconsNameTagOutlineCategoryOutline.module.css";

export interface IOutlineIconsNameTagOutlineCategoryOutlineProps {
  name?:
...
export const OutlineIconsNameTagOutlineCategoryOutline = ({
  name = "equalizer-outline",
  category = "outline",
  className,
  ...props
}: IOutlineIconsNameTagOutlineCategoryOutlineProps): JSX.Element => {
  ...
  return (
    <svg
      className={
        styles.outlineIconsNameTagOutlineCategoryOutline +
        " " +
        className +
        " " +
        variantsClassName
    ...
    >
      <path
        d="M107.05 57.9L62.05 12.9C60.1751 11.0404 57.6407 9.9979 55 10H20C17.3478 10 14.8043 11.0536 12.9289 12.9289C11.0536 14.8043 10 17.3478 10 20V55C9.99896 56.3196 10.2591 57.6263 10.7654 58.8448C11.2717 60.0634 12.0142 61.1697 12.95 62.1L57.95 107.1C59.8249 108.96 62.3593 110.002 65 110C67.6479 109.989 70.1833 108.928 72.05 107.05L107.05 72.05C108.928 70.1833 109.989 67.6479 110 65C110.001 63.6804 109.741 62.3737 109.235 61.1552C108.728 59.9366 107.986 58.8303 107.05 57.9ZM65 100L20 55V20H55L100 65M32.5 25C33.9834 25 35.4334 25.4399 36.6668 26.264C37.9001 27.0881 38.8614 28.2594 39.4291 29.6299C39.9968 31.0003 40.1453 32.5083 39.8559 33.9632C39.5665 35.418 38.8522 36.7544 37.8033 37.8033C36.7544 38.8522 35.418 39.5665 33.9632 39.8559C32.5083 40.1453 31.0003 39.9968 29.6299 39.4291C28.2594 38.8614 27.0881 37.9001 26.264 36.6668C25.4399 35.4334 25 33.9834 25 32.5C25 30.5109 25.7902 28.6032 27.1967 27.1967C28.6032 25.7902 30.5109 25 32.5 25Z"
