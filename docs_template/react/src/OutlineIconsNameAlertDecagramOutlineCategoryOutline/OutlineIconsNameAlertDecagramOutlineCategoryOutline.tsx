import styles from "./OutlineIconsNameAlertDecagramOutlineCategoryOutline.module.css";

export interface IOutlineIconsNameAlertDecagramOutlineCategoryOutlineProps {
  name?:
...
export const OutlineIconsNameAlertDecagramOutlineCategoryOutline = ({
  name = "equalizer-outline",
  category = "outline",
  className,
  ...props
}: IOutlineIconsNameAlertDecagramOutlineCategoryOutlineProps): JSX.Element => {
  ...
  return (
    <svg
      className={
        styles.outlineIconsNameAlertDecagramOutlineCategoryOutline +
        " " +
        className +
        " " +
        variantsClassName
    ...
    >
      <path
        d="M115 60.0002L102.8 73.9002L104.5 92.3002L86.45 96.4002L77 112.3L60 105L43 112.35L33.55 96.4502L15.5 92.3502L17.2 73.9002L5 60.0002L17.2 46.0502L15.5 27.6502L33.55 23.6002L43 7.7002L60 15.0002L77 7.7002L86.45 23.6002L104.5 27.7002L102.8 46.1002L115 60.0002ZM101.65 60.0002L92.5 49.4502L93.7 35.5002L80 32.5002L72.9 20.3502L60 25.9002L47.1 20.3502L40 32.5002L26.3 35.4502L27.5 49.4002L18.35 60.0002L27.5 70.5002L26.3 84.5002L40 87.5002L47.1 99.6502L60 94.0502L72.9 99.6002L80 87.5002L93.7 84.4502L92.5 70.5002L101.65 60.0002ZM55 75.0002H65V85.0002H55V75.0002ZM55 35.0002H65V65.0002H55V35.0002Z"
