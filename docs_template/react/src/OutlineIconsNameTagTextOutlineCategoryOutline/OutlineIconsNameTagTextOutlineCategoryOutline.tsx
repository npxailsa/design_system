import styles from "./OutlineIconsNameTagTextOutlineCategoryOutline.module.css";

export interface IOutlineIconsNameTagTextOutlineCategoryOutlineProps {
  name?:
...
export const OutlineIconsNameTagTextOutlineCategoryOutline = ({
  name = "equalizer-outline",
  category = "outline",
  className,
  ...props
}: IOutlineIconsNameTagTextOutlineCategoryOutlineProps): JSX.Element => {
  ...
  return (
    <svg
      className={
        styles.outlineIconsNameTagTextOutlineCategoryOutline +
        " " +
        className +
        " " +
        variantsClassName
    ...
    >
      <path
        d="M107 58L62 13C60 11 57.5 10 55 10H20C14.5 10 10 14.5 10 20V55C10 57.5 11 60 13 62L58 107C60 109 62.5 110 65 110C67.5 110 70 109 72 107L107 72C109 70 110 67.5 110 65C110 62.5 109 60 107 58ZM65 100L20 55V20H55L100 65M32.5 25C36.5 25 40 28.5 40 32.5C40 36.5 36.5 40 32.5 40C28.5 40 25 36.5 25 32.5C25 28.5 28.5 25 32.5 25ZM50.5 44.5L57.5 37.5L85 65L78 72L50.5 44.5ZM38 57L45 50L65 70L58 77L38 57Z"
