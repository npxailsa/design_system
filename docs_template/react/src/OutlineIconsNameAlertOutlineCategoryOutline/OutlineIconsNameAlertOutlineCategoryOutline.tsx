import styles from "./OutlineIconsNameAlertOutlineCategoryOutline.module.css";

export interface IOutlineIconsNameAlertOutlineCategoryOutlineProps {
  name?:
...
export const OutlineIconsNameAlertOutlineCategoryOutline = ({
  name = "equalizer-outline",
  category = "outline",
  className,
  ...props
}: IOutlineIconsNameAlertOutlineCategoryOutlineProps): JSX.Element => {
  ...
  return (
    <svg
      className={
        styles.outlineIconsNameAlertOutlineCategoryOutline +
        " " +
        className +
        " " +
        variantsClassName
    ...
    >
      <path
        d="M60 10L5 105H115M60 30L97.65 95H22.35M55 50V70H65V50M55 80V90H65V80"
